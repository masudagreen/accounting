...
final class ConsumptionTaxSettlementJsonSerializer
{
    ...
    {
        return array_map([self::class, 'periodToArray'], $periods);
    }
    ...
    {
        return array_map([self::class, 'rateToArray'], $rates);
    }
    ...
    {
        return array_map([self::class, 'categoryToArray'], $categories);
    }
    ...
    {
        return array_map([self::class, 'defaultToArray'], $defaults);
    }
    ...
    {
        return array_map([self::class, 'invoiceRegistrationToArray'], $regs);
    }
}
