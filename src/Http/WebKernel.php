...
final class WebKernel
{
    ...
    public function __construct(
        ...
        $this->routes = [
            ...
            ['method' => 'POST', 'path' => '/ui/journals/{id}/approve',  'handler' => JournalApproveController::class.'@submit', 'public' => false],
            ['method' => 'POST', 'path' => '/ui/journals/{id}/post',     'handler' => JournalPostController::class.'@submit', 'public' => false],
            ['method' => 'GET',  'path' => '/ui/journals/{id}/edit',     'handler' => JournalEditController::class.'@show',   'public' => false],
            ...
            ['method' => 'GET',  'path' => '/ui/trial-balance',          'handler' => TrialBalanceViewController::class,  'public' => false],
