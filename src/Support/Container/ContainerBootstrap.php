...
use Rucaro\Http\Controller\Ui\Journal\JournalApproveController as UiJournalApproveController;
...
use Rucaro\Http\Controller\Ui\Journal\JournalPostController as UiJournalPostController;
...
use Rucaro\Http\Controller\Ui\Report\TrialBalanceViewController as UiTrialBalanceViewController;
...
final class ContainerBootstrap
{
    public static function build(\PDO $pdo): Container
    {
        ...
        $c->set(UlidGenerator::class, static fn (Container $c): UlidGenerator => new UlidGenerator($c->getTyped(ClockInterface::class)));
        $c->set(PasswordHasher::class, static fn (): PasswordHasher => new PasswordHasher());
        $c->set(BearerTokenGenerator::class, static fn (): BearerTokenGenerator => new BearerTokenGenerator());

        // Repositories
        $c->set(
            UserRepositoryInterface::class,
            static fn (Container $c): UserRepositoryInterface => new PdoUserRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            EntityRepositoryInterface::class,
            static fn (Container $c): EntityRepositoryInterface => new PdoEntityRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            AccountTitleRepositoryInterface::class,
            static fn (Container $c): AccountTitleRepositoryInterface => new PdoAccountTitleRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            SubAccountTitleRepositoryInterface::class,
            static fn (Container $c): SubAccountTitleRepositoryInterface => new PdoSubAccountTitleRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            FiscalTermRepositoryInterface::class,
            static fn (Container $c): FiscalTermRepositoryInterface => new PdoFiscalTermRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            JournalRepositoryInterface::class,
            static fn (Container $c): JournalRepositoryInterface => new PdoJournalRepository(
        ...
        $c->set(
            ...
            static fn (Container $c): ApiTokenRepositoryInterface => new PdoApiTokenRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            TrialBalanceQueryInterface::class,
            static fn (Container $c): TrialBalanceQueryInterface => new PdoTrialBalanceQueryService($c->getTyped(\PDO::class)),
        );
        $c->set(
            TrialBalanceSnapshotRepositoryInterface::class,
            static fn (Container $c): TrialBalanceSnapshotRepositoryInterface => new PdoTrialBalanceSnapshotRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            LedgerQueryInterface::class,
            static fn (Container $c): LedgerQueryInterface => new PdoLedgerQueryService($c->getTyped(\PDO::class)),
        );
        $c->set(
            OpeningBalanceRepositoryInterface::class,
            // Wave 6 wired Zero by default while `opening_balances` was empty.
            // Phase B-3a: now that the importer's `opening-balances` stage
            // populates the table from legacy `accountingLogCalcJpn`, the
            // PDO-backed implementation is the production default. Tests that
            // need 期首=0 keep using ZeroOpeningBalanceRepository directly.
            static fn (Container $c): OpeningBalanceRepositoryInterface => new PdoOpeningBalanceRepository($c->getTyped(\PDO::class)),
        );

        // Middleware
        $c->set(
            AuthenticateBearer::class,
            static fn (Container $c): AuthenticateBearer => new AuthenticateBearer(
        ...
        // Use cases
        $c->set(LoginUseCase::class, static fn (Container $c): LoginUseCase => new LoginUseCase(
        ...
        $c->set(GetMyProfileUseCase::class, static fn (Container $c): GetMyProfileUseCase => new GetMyProfileUseCase($c->getTyped(UserRepositoryInterface::class)));
        $c->set(ListEntitiesUseCase::class, static fn (Container $c): ListEntitiesUseCase => new ListEntitiesUseCase($c->getTyped(EntityRepositoryInterface::class)));
        $c->set(ListAccountTitlesUseCase::class, static fn (Container $c): ListAccountTitlesUseCase => new ListAccountTitlesUseCase($c->getTyped(AccountTitleRepositoryInterface::class)));
        $c->set(ListJournalsUseCase::class, static fn (Container $c): ListJournalsUseCase => new ListJournalsUseCase($c->getTyped(JournalRepositoryInterface::class)));
        $c->set(CreateJournalUseCase::class, static fn (Container $c): CreateJournalUseCase => new CreateJournalUseCase(
            journals: $c->getTyped(JournalRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(UpdateJournalUseCase::class, static fn (Container $c): UpdateJournalUseCase => new UpdateJournalUseCase(
            journals: $c->getTyped(JournalRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(DeleteJournalUseCase::class, static fn (Container $c): DeleteJournalUseCase => new DeleteJournalUseCase(
            journals: $c->getTyped(JournalRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(ApproveJournalUseCase::class, static fn (Container $c): ApproveJournalUseCase => new ApproveJournalUseCase(
            journals: $c->getTyped(JournalRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(PostJournalUseCase::class, static fn (Container $c): PostJournalUseCase => new PostJournalUseCase(
            journals: $c->getTyped(JournalRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(JournalReverser::class, static fn (Container $c): JournalReverser => new JournalReverser($c->getTyped(UlidGenerator::class)));
        $c->set(ReverseJournalUseCase::class, static fn (Container $c): ReverseJournalUseCase => new ReverseJournalUseCase(
            journals: $c->getTyped(JournalRepositoryInterface::class),
            reverser: $c->getTyped(JournalReverser::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(SearchJournalUseCase::class, static fn (Container $c): SearchJournalUseCase => new SearchJournalUseCase($c->getTyped(JournalRepositoryInterface::class)));
        $c->set(QueryTrialBalanceUseCase::class, static fn (Container $c): QueryTrialBalanceUseCase => new QueryTrialBalanceUseCase(
        ...
        $c->set(RefreshTrialBalanceSnapshotUseCase::class, static fn (Container $c): RefreshTrialBalanceSnapshotUseCase => new RefreshTrialBalanceSnapshotUseCase(
            query: $c->getTyped(TrialBalanceQueryInterface::class),
            snapshots: $c->getTyped(TrialBalanceSnapshotRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(QueryLedgerUseCase::class, static fn (Container $c): QueryLedgerUseCase => new QueryLedgerUseCase(
        ...
        // Controllers
        $c->set(LoginController::class, static fn (Container $c): LoginController => new LoginController($c->getTyped(LoginUseCase::class)));
        $c->set(MeController::class, static fn (Container $c): MeController => new MeController(
            $c->getTyped(GetMyProfileUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ListEntityController::class, static fn (Container $c): ListEntityController => new ListEntityController(
            $c->getTyped(ListEntitiesUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ListAccountTitleController::class, static fn (Container $c): ListAccountTitleController => new ListAccountTitleController(
            $c->getTyped(ListAccountTitlesUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ListJournalController::class, static fn (Container $c): ListJournalController => new ListJournalController(
            $c->getTyped(ListJournalsUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(CreateJournalController::class, static fn (Container $c): CreateJournalController => new CreateJournalController(
            $c->getTyped(CreateJournalUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(GetJournalController::class, static fn (Container $c): GetJournalController => new GetJournalController(
            $c->getTyped(JournalRepositoryInterface::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(UpdateJournalController::class, static fn (Container $c): UpdateJournalController => new UpdateJournalController(
            $c->getTyped(UpdateJournalUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(DeleteJournalController::class, static fn (Container $c): DeleteJournalController => new DeleteJournalController(
            $c->getTyped(DeleteJournalUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ApproveJournalController::class, static fn (Container $c): ApproveJournalController => new ApproveJournalController(
            $c->getTyped(ApproveJournalUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(GetTrialBalanceController::class, static fn (Container $c): GetTrialBalanceController => new GetTrialBalanceController(
        ...
        $c->set(
            ...
            static fn (Container $c): GetLedgerController => new GetLedgerController(
        ...
        $c->set(
            ...
            static fn (Container $c): AccountTitleFsMappingRepositoryInterface => new PdoAccountTitleFsMappingRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            FsSectionDefinitionRepositoryInterface::class,
            static fn (Container $c): FsSectionDefinitionRepositoryInterface => new PdoFsSectionDefinitionRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
        ...
        $c->set(
            ...
            static fn (Container $c): AccountTitleCsMappingRepositoryInterface => new PdoAccountTitleCsMappingRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            CsSectionDefinitionRepositoryInterface::class,
            static fn (Container $c): CsSectionDefinitionRepositoryInterface => new PdoCsSectionDefinitionRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
        ...
        $c->set(
            ...
            static fn (Container $c): GenerateFinancialStatementUseCase => new GenerateFinancialStatementUseCase(
        ...
        $c->set(
            ...
            static fn (Container $c): GetFinancialStatementController => new GetFinancialStatementController(
        ...
        $c->set(
            ...
            static fn (Container $c): FiscalTermMetadataRepositoryInterface => new PdoFiscalTermMetadataRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            FinancialStatementProviderInterface::class,
            static fn (Container $c): FinancialStatementProviderInterface => new class($c->getTyped(GenerateFinancialStatementUseCase::class)) implements FinancialStatementProviderInterface {
        ...
        $c->set(
            ...
            static fn (Container $c): GenerateMultiPeriodFinancialStatementUseCase => new GenerateMultiPeriodFinancialStatementUseCase(
        ...
        $c->set(
            ...
            static fn (Container $c): GetMultiPeriodFinancialStatementController => new GetMultiPeriodFinancialStatementController(
        ...
        $c->set(
            ...
            static fn (Container $c): ApprovalTokenRepositoryInterface => new PdoApprovalTokenRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            ApprovalTargetResolverInterface::class,
            static fn (Container $c): ApprovalTargetResolverInterface => new JournalApprovalTargetResolver($c->getTyped(JournalRepositoryInterface::class)),
        );
        $c->set(
            MailSenderInterface::class,
            static function (Container $c): MailSenderInterface {
                $mailer = getenv('MAIL_MAILER') ?: 'null';
        ...
        $c->set(
            ...
            static function (Container $c): ApprovalNotifierInterface {
                ...
                $approveTpl = getenv('APPROVAL_APPROVE_URL_TEMPLATE') ?: ($appUrl.'/api/v1/approvals/?token={token}&decision=approved');
                $rejectTpl = getenv('APPROVAL_REJECT_URL_TEMPLATE') ?: ($appUrl.'/api/v1/approvals/?token={token}&decision=rejected');
                $repoRoot = dirname(__DIR__, 3);
        ...
        $c->set(
            ...
            static fn (Container $c): FindApprovalByTokenUseCase => new FindApprovalByTokenUseCase(
                tokens: $c->getTyped(ApprovalTokenRepositoryInterface::class),
                targets: $c->getTyped(ApprovalTargetResolverInterface::class),
                clock: $c->getTyped(ClockInterface::class),
            ),
        ...
        $c->set(
            ...
            static fn (Container $c): RespondToApprovalUseCase => new RespondToApprovalUseCase(
                tokens: $c->getTyped(ApprovalTokenRepositoryInterface::class),
                targets: $c->getTyped(ApprovalTargetResolverInterface::class),
                clock: $c->getTyped(ClockInterface::class),
            ),
        ...
        $c->set(
            ...
            static fn (Container $c): ResendApprovalUseCase => new ResendApprovalUseCase(
                tokens: $c->getTyped(ApprovalTokenRepositoryInterface::class),
        ...
        $c->set(
            ...
            static fn (Container $c): ExpirePastDueApprovalsUseCase => new ExpirePastDueApprovalsUseCase(
                tokens: $c->getTyped(ApprovalTokenRepositoryInterface::class),
                clock: $c->getTyped(ClockInterface::class),
            ),
        );
        $c->set(
            ...
            static fn (Container $c): RequestApprovalController => new RequestApprovalController(
        ...
        $c->set(
            ...
            static fn (Container $c): GetApprovalController => new GetApprovalController($c->getTyped(FindApprovalByTokenUseCase::class)),
        );
        $c->set(
            PostApprovalController::class,
            static fn (Container $c): PostApprovalController => new PostApprovalController($c->getTyped(RespondToApprovalUseCase::class)),
        );
        $c->set(
            ResendApprovalController::class,
            static fn (Container $c): ResendApprovalController => new ResendApprovalController(
        ...
        $c->set(
            ...
            static fn (Container $c): FixedAssetRepositoryInterface => new PdoFixedAssetRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            DepreciationScheduleRepositoryInterface::class,
            static fn (Container $c): DepreciationScheduleRepositoryInterface => new PdoDepreciationScheduleRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            FixedAssetCategoryRepositoryInterface::class,
            static fn (Container $c): FixedAssetCategoryRepositoryInterface => new PdoFixedAssetCategoryRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
        ...
        $c->set(CreateFixedAssetUseCase::class, static fn (Container $c): CreateFixedAssetUseCase => new CreateFixedAssetUseCase(
            assets: $c->getTyped(FixedAssetRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(UpdateFixedAssetUseCase::class, static fn (Container $c): UpdateFixedAssetUseCase => new UpdateFixedAssetUseCase(
            assets: $c->getTyped(FixedAssetRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(DisposeFixedAssetUseCase::class, static fn (Container $c): DisposeFixedAssetUseCase => new DisposeFixedAssetUseCase(
            assets: $c->getTyped(FixedAssetRepositoryInterface::class),
        ));
        $c->set(ListFixedAssetsUseCase::class, static fn (Container $c): ListFixedAssetsUseCase => new ListFixedAssetsUseCase(
            assets: $c->getTyped(FixedAssetRepositoryInterface::class),
        ));
        $c->set(GetFixedAssetUseCase::class, static fn (Container $c): GetFixedAssetUseCase => new GetFixedAssetUseCase(
            assets: $c->getTyped(FixedAssetRepositoryInterface::class),
        ));
        $c->set(GenerateDepreciationScheduleUseCase::class, static fn (Container $c): GenerateDepreciationScheduleUseCase => new GenerateDepreciationScheduleUseCase(
            assets: $c->getTyped(FixedAssetRepositoryInterface::class),
        ...
        $c->set(PostDepreciationJournalUseCase::class, static fn (Container $c): PostDepreciationJournalUseCase => new PostDepreciationJournalUseCase(
            assets: $c->getTyped(FixedAssetRepositoryInterface::class),
            schedules: $c->getTyped(DepreciationScheduleRepositoryInterface::class),
            journals: $c->getTyped(JournalRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
        ...
        $c->set(GetFixedAssetLedgerUseCase::class, static fn (Container $c): GetFixedAssetLedgerUseCase => new GetFixedAssetLedgerUseCase(
            assets: $c->getTyped(FixedAssetRepositoryInterface::class),
            schedules: $c->getTyped(DepreciationScheduleRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(ListFixedAssetController::class, static fn (Container $c): ListFixedAssetController => new ListFixedAssetController(
            $c->getTyped(ListFixedAssetsUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(GetFixedAssetController::class, static fn (Container $c): GetFixedAssetController => new GetFixedAssetController(
            $c->getTyped(GetFixedAssetUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(CreateFixedAssetController::class, static fn (Container $c): CreateFixedAssetController => new CreateFixedAssetController(
            $c->getTyped(CreateFixedAssetUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(UpdateFixedAssetController::class, static fn (Container $c): UpdateFixedAssetController => new UpdateFixedAssetController(
            $c->getTyped(UpdateFixedAssetUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(DisposeFixedAssetController::class, static fn (Container $c): DisposeFixedAssetController => new DisposeFixedAssetController(
            $c->getTyped(DisposeFixedAssetUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(GenerateDepreciationController::class, static fn (Container $c): GenerateDepreciationController => new GenerateDepreciationController(
            $c->getTyped(GenerateDepreciationScheduleUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
            $c->getTyped(\PDO::class),
        ));
        $c->set(PostDepreciationJournalController::class, static fn (Container $c): PostDepreciationJournalController => new PostDepreciationJournalController(
            $c->getTyped(PostDepreciationJournalUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(GetFixedAssetLedgerController::class, static fn (Container $c): GetFixedAssetLedgerController => new GetFixedAssetLedgerController(
        ...
        $c->set(
            ...
            static fn (Container $c): CashPlanRepositoryInterface => new PdoCashPlanRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
        ...
        $c->set(CreateCashPlanUseCase::class, static fn (Container $c): CreateCashPlanUseCase => new CreateCashPlanUseCase(
            plans: $c->getTyped(CashPlanRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(UpdateCashPlanUseCase::class, static fn (Container $c): UpdateCashPlanUseCase => new UpdateCashPlanUseCase(
            plans: $c->getTyped(CashPlanRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(ListCashPlansUseCase::class, static fn (Container $c): ListCashPlansUseCase => new ListCashPlansUseCase($c->getTyped(CashPlanRepositoryInterface::class)));
        $c->set(GetCashPlanUseCase::class, static fn (Container $c): GetCashPlanUseCase => new GetCashPlanUseCase($c->getTyped(CashPlanRepositoryInterface::class)));
        $c->set(DeleteCashPlanUseCase::class, static fn (Container $c): DeleteCashPlanUseCase => new DeleteCashPlanUseCase($c->getTyped(CashPlanRepositoryInterface::class)));
        $c->set(ListCashPlanController::class, static fn (Container $c): ListCashPlanController => new ListCashPlanController(
            $c->getTyped(ListCashPlansUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(GetCashPlanController::class, static fn (Container $c): GetCashPlanController => new GetCashPlanController(
            $c->getTyped(GetCashPlanUseCase::class),
            $c->getTyped(CashPlanPdfGeneratorInterface::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(CreateCashPlanController::class, static fn (Container $c): CreateCashPlanController => new CreateCashPlanController(
            $c->getTyped(CreateCashPlanUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(UpdateCashPlanController::class, static fn (Container $c): UpdateCashPlanController => new UpdateCashPlanController(
            $c->getTyped(UpdateCashPlanUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(DeleteCashPlanController::class, static fn (Container $c): DeleteCashPlanController => new DeleteCashPlanController(
        ...
        $c->set(
            ...
            static fn (Container $c): AccountTitleCvpClassificationRepositoryInterface => new PdoAccountTitleCvpClassificationRepository(
                $c->getTyped(\PDO::class),
                $c->getTyped(UlidGenerator::class),
            ),
        );
        ...
        $c->set(AnalyzeBreakEvenPointUseCase::class, static fn (Container $c): AnalyzeBreakEvenPointUseCase => new AnalyzeBreakEvenPointUseCase(
            trialBalance: $c->getTyped(QueryTrialBalanceUseCase::class),
        ...
        $c->set(ListCvpClassificationsUseCase::class, static fn (Container $c): ListCvpClassificationsUseCase => new ListCvpClassificationsUseCase($c->getTyped(AccountTitleCvpClassificationRepositoryInterface::class)));
        $c->set(UpsertCvpClassificationsUseCase::class, static fn (Container $c): UpsertCvpClassificationsUseCase => new UpsertCvpClassificationsUseCase($c->getTyped(AccountTitleCvpClassificationRepositoryInterface::class)));
        $c->set(GetBreakEvenPointController::class, static fn (Container $c): GetBreakEvenPointController => new GetBreakEvenPointController(
            $c->getTyped(AnalyzeBreakEvenPointUseCase::class),
            $c->getTyped(BreakEvenPointPdfGeneratorInterface::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ListCvpClassificationController::class, static fn (Container $c): ListCvpClassificationController => new ListCvpClassificationController(
            $c->getTyped(ListCvpClassificationsUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(PutCvpClassificationController::class, static fn (Container $c): PutCvpClassificationController => new PutCvpClassificationController(
        ...
        $c->set(
            ...
            static fn (Container $c): ConsumptionTaxRateRepositoryInterface => new PdoConsumptionTaxRateRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            ConsumptionTaxCategoryRepositoryInterface::class,
            static fn (Container $c): ConsumptionTaxCategoryRepositoryInterface => new PdoConsumptionTaxCategoryRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            AccountTitleConsumptionTaxDefaultRepositoryInterface::class,
            static fn (Container $c): AccountTitleConsumptionTaxDefaultRepositoryInterface => new PdoAccountTitleConsumptionTaxDefaultRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            InvoiceRegistrationRepositoryInterface::class,
            static fn (Container $c): InvoiceRegistrationRepositoryInterface => new PdoInvoiceRegistrationRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            ConsumptionTaxPeriodRepositoryInterface::class,
            static fn (Container $c): ConsumptionTaxPeriodRepositoryInterface => new PdoConsumptionTaxPeriodRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            TaxableTransactionQueryInterface::class,
            static fn (Container $c): TaxableTransactionQueryInterface => new PdoTaxableTransactionQueryService($c->getTyped(\PDO::class)),
        );
        $c->set(InvoiceDeductionCalculator::class, static fn (Container $c): InvoiceDeductionCalculator => new InvoiceDeductionCalculator());
        $c->set(ConsumptionTaxCalculatorFactory::class, static fn (Container $c): ConsumptionTaxCalculatorFactory => new ConsumptionTaxCalculatorFactory($c->getTyped(InvoiceDeductionCalculator::class)));
        $c->set(
        ...
        // Use cases
        $c->set(ListConsumptionTaxRatesUseCase::class, static fn (Container $c): ListConsumptionTaxRatesUseCase => new ListConsumptionTaxRatesUseCase($c->getTyped(ConsumptionTaxRateRepositoryInterface::class)));
        $c->set(ListConsumptionTaxCategoriesUseCase::class, static fn (Container $c): ListConsumptionTaxCategoriesUseCase => new ListConsumptionTaxCategoriesUseCase($c->getTyped(ConsumptionTaxCategoryRepositoryInterface::class)));
        $c->set(ListAccountTitleTaxDefaultsUseCase::class, static fn (Container $c): ListAccountTitleTaxDefaultsUseCase => new ListAccountTitleTaxDefaultsUseCase($c->getTyped(AccountTitleConsumptionTaxDefaultRepositoryInterface::class)));
        $c->set(UpsertAccountTitleTaxDefaultsUseCase::class, static fn (Container $c): UpsertAccountTitleTaxDefaultsUseCase => new UpsertAccountTitleTaxDefaultsUseCase(
            defaults: $c->getTyped(AccountTitleConsumptionTaxDefaultRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(ListInvoiceRegistrationsUseCase::class, static fn (Container $c): ListInvoiceRegistrationsUseCase => new ListInvoiceRegistrationsUseCase($c->getTyped(InvoiceRegistrationRepositoryInterface::class)));
        $c->set(UpsertInvoiceRegistrationUseCase::class, static fn (Container $c): UpsertInvoiceRegistrationUseCase => new UpsertInvoiceRegistrationUseCase(
            registrations: $c->getTyped(InvoiceRegistrationRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(ListConsumptionTaxPeriodsUseCase::class, static fn (Container $c): ListConsumptionTaxPeriodsUseCase => new ListConsumptionTaxPeriodsUseCase($c->getTyped(ConsumptionTaxPeriodRepositoryInterface::class)));
        $c->set(CreateConsumptionTaxPeriodUseCase::class, static fn (Container $c): CreateConsumptionTaxPeriodUseCase => new CreateConsumptionTaxPeriodUseCase(
            periods: $c->getTyped(ConsumptionTaxPeriodRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(CalculateConsumptionTaxUseCase::class, static fn (Container $c): CalculateConsumptionTaxUseCase => new CalculateConsumptionTaxUseCase(
            periods: $c->getTyped(ConsumptionTaxPeriodRepositoryInterface::class),
            transactions: $c->getTyped(TaxableTransactionQueryInterface::class),
            factory: $c->getTyped(ConsumptionTaxCalculatorFactory::class),
        ));
        $c->set(GenerateConsumptionTaxReportUseCase::class, static fn (Container $c): GenerateConsumptionTaxReportUseCase => new GenerateConsumptionTaxReportUseCase(
            calculate: $c->getTyped(CalculateConsumptionTaxUseCase::class),
        ));

        // Controllers
        $c->set(ListConsumptionTaxRatesController::class, static fn (Container $c): ListConsumptionTaxRatesController => new ListConsumptionTaxRatesController(
            $c->getTyped(ListConsumptionTaxRatesUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ListConsumptionTaxCategoriesController::class, static fn (Container $c): ListConsumptionTaxCategoriesController => new ListConsumptionTaxCategoriesController(
            $c->getTyped(ListConsumptionTaxCategoriesUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ListAccountTitleTaxDefaultsController::class, static fn (Container $c): ListAccountTitleTaxDefaultsController => new ListAccountTitleTaxDefaultsController(
            $c->getTyped(ListAccountTitleTaxDefaultsUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(PutAccountTitleTaxDefaultsController::class, static fn (Container $c): PutAccountTitleTaxDefaultsController => new PutAccountTitleTaxDefaultsController(
            $c->getTyped(UpsertAccountTitleTaxDefaultsUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ListInvoiceRegistrationsController::class, static fn (Container $c): ListInvoiceRegistrationsController => new ListInvoiceRegistrationsController(
            $c->getTyped(ListInvoiceRegistrationsUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(UpsertInvoiceRegistrationController::class, static fn (Container $c): UpsertInvoiceRegistrationController => new UpsertInvoiceRegistrationController(
            $c->getTyped(UpsertInvoiceRegistrationUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ListConsumptionTaxPeriodsController::class, static fn (Container $c): ListConsumptionTaxPeriodsController => new ListConsumptionTaxPeriodsController(
            $c->getTyped(ListConsumptionTaxPeriodsUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(CreateConsumptionTaxPeriodController::class, static fn (Container $c): CreateConsumptionTaxPeriodController => new CreateConsumptionTaxPeriodController(
            $c->getTyped(CreateConsumptionTaxPeriodUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(CalculateConsumptionTaxController::class, static fn (Container $c): CalculateConsumptionTaxController => new CalculateConsumptionTaxController(
            $c->getTyped(CalculateConsumptionTaxUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(GetConsumptionTaxReportController::class, static fn (Container $c): GetConsumptionTaxReportController => new GetConsumptionTaxReportController(
        ...
        $c->set(
            ...
            static fn (Container $c): BudgetRepositoryInterface => new PdoBudgetRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
        ...
        $c->set(CreateBudgetUseCase::class, static fn (Container $c): CreateBudgetUseCase => new CreateBudgetUseCase(
            budgets: $c->getTyped(BudgetRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(UpdateBudgetUseCase::class, static fn (Container $c): UpdateBudgetUseCase => new UpdateBudgetUseCase(
            budgets: $c->getTyped(BudgetRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(ApproveBudgetUseCase::class, static fn (Container $c): ApproveBudgetUseCase => new ApproveBudgetUseCase(
            budgets: $c->getTyped(BudgetRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(LockBudgetUseCase::class, static fn (Container $c): LockBudgetUseCase => new LockBudgetUseCase(
            budgets: $c->getTyped(BudgetRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(DeleteBudgetUseCase::class, static fn (Container $c): DeleteBudgetUseCase => new DeleteBudgetUseCase($c->getTyped(BudgetRepositoryInterface::class)));
        $c->set(ListBudgetsUseCase::class, static fn (Container $c): ListBudgetsUseCase => new ListBudgetsUseCase($c->getTyped(BudgetRepositoryInterface::class)));
        $c->set(GetBudgetUseCase::class, static fn (Container $c): GetBudgetUseCase => new GetBudgetUseCase($c->getTyped(BudgetRepositoryInterface::class)));
        $c->set(AnalyzeBudgetVarianceUseCase::class, static fn (Container $c): AnalyzeBudgetVarianceUseCase => new AnalyzeBudgetVarianceUseCase(
            budgets: $c->getTyped(BudgetRepositoryInterface::class),
            trialBalance: $c->getTyped(QueryTrialBalanceUseCase::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(ListBudgetController::class, static fn (Container $c): ListBudgetController => new ListBudgetController(
            $c->getTyped(ListBudgetsUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(GetBudgetController::class, static fn (Container $c): GetBudgetController => new GetBudgetController(
            $c->getTyped(GetBudgetUseCase::class),
            $c->getTyped(BudgetPdfGeneratorInterface::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(CreateBudgetController::class, static fn (Container $c): CreateBudgetController => new CreateBudgetController(
            $c->getTyped(CreateBudgetUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(UpdateBudgetController::class, static fn (Container $c): UpdateBudgetController => new UpdateBudgetController(
            $c->getTyped(UpdateBudgetUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(DeleteBudgetController::class, static fn (Container $c): DeleteBudgetController => new DeleteBudgetController(
            $c->getTyped(DeleteBudgetUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ApproveBudgetController::class, static fn (Container $c): ApproveBudgetController => new ApproveBudgetController(
            $c->getTyped(ApproveBudgetUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(LockBudgetController::class, static fn (Container $c): LockBudgetController => new LockBudgetController(
            $c->getTyped(LockBudgetUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(GetBudgetVarianceController::class, static fn (Container $c): GetBudgetVarianceController => new GetBudgetVarianceController(
            $c->getTyped(GetBudgetUseCase::class),
        ...
        $c->set(
            ...
            static fn (Container $c): SsManualAdjustmentRepositoryInterface => new PdoSsManualAdjustmentRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
        ...
        $c->set(GenerateStatementOfChangesInEquityUseCase::class, static fn (Container $c): GenerateStatementOfChangesInEquityUseCase => new GenerateStatementOfChangesInEquityUseCase(
            repo: $c->getTyped(SsManualAdjustmentRepositoryInterface::class),
            builder: $c->getTyped(StatementOfChangesInEquityBuilder::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(ListSsAdjustmentsUseCase::class, static fn (Container $c): ListSsAdjustmentsUseCase => new ListSsAdjustmentsUseCase($c->getTyped(SsManualAdjustmentRepositoryInterface::class)));
        $c->set(CreateSsAdjustmentUseCase::class, static fn (Container $c): CreateSsAdjustmentUseCase => new CreateSsAdjustmentUseCase(
            repo: $c->getTyped(SsManualAdjustmentRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
        ));
        $c->set(UpdateSsAdjustmentUseCase::class, static fn (Container $c): UpdateSsAdjustmentUseCase => new UpdateSsAdjustmentUseCase($c->getTyped(SsManualAdjustmentRepositoryInterface::class)));
        $c->set(DeleteSsAdjustmentUseCase::class, static fn (Container $c): DeleteSsAdjustmentUseCase => new DeleteSsAdjustmentUseCase($c->getTyped(SsManualAdjustmentRepositoryInterface::class)));
        $c->set(GetStatementOfChangesInEquityController::class, static fn (Container $c): GetStatementOfChangesInEquityController => new GetStatementOfChangesInEquityController(
        ...
        $c->set(ListSsAdjustmentsController::class, static fn (Container $c): ListSsAdjustmentsController => new ListSsAdjustmentsController(
            $c->getTyped(ListSsAdjustmentsUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(CreateSsAdjustmentController::class, static fn (Container $c): CreateSsAdjustmentController => new CreateSsAdjustmentController(
            $c->getTyped(CreateSsAdjustmentUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(UpdateSsAdjustmentController::class, static fn (Container $c): UpdateSsAdjustmentController => new UpdateSsAdjustmentController(
            $c->getTyped(UpdateSsAdjustmentUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(DeleteSsAdjustmentController::class, static fn (Container $c): DeleteSsAdjustmentController => new DeleteSsAdjustmentController(
        ...
        $c->set(
            ...
            static fn (Container $c): BlueReturnRepositoryInterface => new PdoBlueReturnRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
        ...
        $c->set(CreateBlueReturnUseCase::class, static fn (Container $c): CreateBlueReturnUseCase => new CreateBlueReturnUseCase(
            forms: $c->getTyped(BlueReturnRepositoryInterface::class),
            entities: $c->getTyped(EntityRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(UpdateBlueReturnUseCase::class, static fn (Container $c): UpdateBlueReturnUseCase => new UpdateBlueReturnUseCase(
            forms: $c->getTyped(BlueReturnRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(FinalizeBlueReturnUseCase::class, static fn (Container $c): FinalizeBlueReturnUseCase => new FinalizeBlueReturnUseCase(
            forms: $c->getTyped(BlueReturnRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(DeleteBlueReturnUseCase::class, static fn (Container $c): DeleteBlueReturnUseCase => new DeleteBlueReturnUseCase($c->getTyped(BlueReturnRepositoryInterface::class)));
        $c->set(GetBlueReturnUseCase::class, static fn (Container $c): GetBlueReturnUseCase => new GetBlueReturnUseCase($c->getTyped(BlueReturnRepositoryInterface::class)));
        $c->set(ListBlueReturnsUseCase::class, static fn (Container $c): ListBlueReturnsUseCase => new ListBlueReturnsUseCase($c->getTyped(BlueReturnRepositoryInterface::class)));
        $c->set(GenerateBlueReturnSnapshotUseCase::class, static fn (Container $c): GenerateBlueReturnSnapshotUseCase => new GenerateBlueReturnSnapshotUseCase($c->getTyped(BlueReturnBuilder::class)));
        $c->set(CreateBlueReturnController::class, static fn (Container $c): CreateBlueReturnController => new CreateBlueReturnController(
            $c->getTyped(CreateBlueReturnUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(UpdateBlueReturnController::class, static fn (Container $c): UpdateBlueReturnController => new UpdateBlueReturnController(
            $c->getTyped(UpdateBlueReturnUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(GetBlueReturnController::class, static fn (Container $c): GetBlueReturnController => new GetBlueReturnController(
            $c->getTyped(GetBlueReturnUseCase::class),
            $c->getTyped(BlueReturnPdfGeneratorInterface::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ListBlueReturnController::class, static fn (Container $c): ListBlueReturnController => new ListBlueReturnController(
            $c->getTyped(ListBlueReturnsUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(DeleteBlueReturnController::class, static fn (Container $c): DeleteBlueReturnController => new DeleteBlueReturnController(
            $c->getTyped(DeleteBlueReturnUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(FinalizeBlueReturnController::class, static fn (Container $c): FinalizeBlueReturnController => new FinalizeBlueReturnController(
        ...
        $c->set(
            ...
            static fn (Container $c): FsNoteRepositoryInterface => new PdoFsNoteRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
            FsNoteTemplateRepositoryInterface::class,
            static fn (Container $c): FsNoteTemplateRepositoryInterface => new PdoFsNoteTemplateRepository($c->getTyped(\PDO::class)),
        );
        $c->set(
        ...
        $c->set(ListFsNoteTemplatesUseCase::class, static fn (Container $c): ListFsNoteTemplatesUseCase => new ListFsNoteTemplatesUseCase($c->getTyped(FsNoteTemplateRepositoryInterface::class)));
        $c->set(ListFsNotesUseCase::class, static fn (Container $c): ListFsNotesUseCase => new ListFsNotesUseCase($c->getTyped(FsNoteRepositoryInterface::class)));
        $c->set(GetFsNoteUseCase::class, static fn (Container $c): GetFsNoteUseCase => new GetFsNoteUseCase($c->getTyped(FsNoteRepositoryInterface::class)));
        $c->set(CreateFsNoteUseCase::class, static fn (Container $c): CreateFsNoteUseCase => new CreateFsNoteUseCase(
            notes: $c->getTyped(FsNoteRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(UpdateFsNoteUseCase::class, static fn (Container $c): UpdateFsNoteUseCase => new UpdateFsNoteUseCase(
            notes: $c->getTyped(FsNoteRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(DeleteFsNoteUseCase::class, static fn (Container $c): DeleteFsNoteUseCase => new DeleteFsNoteUseCase($c->getTyped(FsNoteRepositoryInterface::class)));
        $c->set(ReorderFsNotesUseCase::class, static fn (Container $c): ReorderFsNotesUseCase => new ReorderFsNotesUseCase(
            notes: $c->getTyped(FsNoteRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(BulkImportFsNotesFromTemplatesUseCase::class, static fn (Container $c): BulkImportFsNotesFromTemplatesUseCase => new BulkImportFsNotesFromTemplatesUseCase(
            notes: $c->getTyped(FsNoteRepositoryInterface::class),
            templates: $c->getTyped(FsNoteTemplateRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(ListFsNoteTemplatesController::class, static fn (Container $c): ListFsNoteTemplatesController => new ListFsNoteTemplatesController(
            $c->getTyped(ListFsNoteTemplatesUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ListFsNotesController::class, static fn (Container $c): ListFsNotesController => new ListFsNotesController(
            $c->getTyped(ListFsNotesUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(GetFsNoteController::class, static fn (Container $c): GetFsNoteController => new GetFsNoteController(
            $c->getTyped(GetFsNoteUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(CreateFsNoteController::class, static fn (Container $c): CreateFsNoteController => new CreateFsNoteController(
            $c->getTyped(CreateFsNoteUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(UpdateFsNoteController::class, static fn (Container $c): UpdateFsNoteController => new UpdateFsNoteController(
            $c->getTyped(UpdateFsNoteUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(DeleteFsNoteController::class, static fn (Container $c): DeleteFsNoteController => new DeleteFsNoteController(
            $c->getTyped(DeleteFsNoteUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(BulkImportFsNotesController::class, static fn (Container $c): BulkImportFsNotesController => new BulkImportFsNotesController(
            $c->getTyped(BulkImportFsNotesFromTemplatesUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ReorderFsNotesController::class, static fn (Container $c): ReorderFsNotesController => new ReorderFsNotesController(
            $c->getTyped(ReorderFsNotesUseCase::class),
            $c->getTyped(AuthenticateBearer::class),
        ));
        $c->set(ExportFsNotesController::class, static fn (Container $c): ExportFsNotesController => new ExportFsNotesController(
            $c->getTyped(ListFsNotesUseCase::class),
        ...
        $c->set(CsrfTokenManager::class, static fn (Container $c): CsrfTokenManager => new CsrfTokenManager($c->getTyped(ClockInterface::class)));
        ...
        $c->set(SmartyViewRenderer::class, static function (Container $c): SmartyViewRenderer {
            ...
            return new SmartyViewRenderer(
                $templateDir,
                $compileDir,
                $c->getTyped(\Rucaro\Support\Web\NavbarLookup::class),
                $c->getTyped(SessionStore::class),
            );
        });
        $c->set(\Rucaro\Support\Web\NavbarLookup::class, static fn (Container $c): \Rucaro\Support\Web\NavbarLookup => new \Rucaro\Support\Web\NavbarLookup(
            $c->getTyped(\PDO::class),
        ));
        $c->set(\Rucaro\Support\Web\UserDisplayLookup::class, static fn (Container $c): \Rucaro\Support\Web\UserDisplayLookup => new \Rucaro\Support\Web\UserDisplayLookup(
            $c->getTyped(\PDO::class),
        ));
        // F-1: feeds the navbar's fiscal-term <select>; intentionally a tiny
        // PDO-only adapter so any UI controller can depend on it without
        // importing Journal-specific code.
        $c->set(\Rucaro\Support\Web\FiscalTermLookup::class, static fn (Container $c): \Rucaro\Support\Web\FiscalTermLookup => new \Rucaro\Support\Web\FiscalTermLookup(
            $c->getTyped(\PDO::class),
        ));
        $c->set(AuthenticateSession::class, static fn (Container $c): AuthenticateSession => new AuthenticateSession(
            tokens: $c->getTyped(ApiTokenRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
            session: $c->getTyped(SessionStore::class),
        ));
        $c->set(UiLoginController::class, static fn (Container $c): UiLoginController => new UiLoginController(
        ...
        $c->set(UiLogoutController::class, static fn (Container $c): UiLogoutController => new UiLogoutController(
            tokens: $c->getTyped(ApiTokenRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
            session: $c->getTyped(SessionStore::class),
            csrf: $c->getTyped(CsrfTokenManager::class),
        ...
        $c->set(UiDashboardController::class, static fn (Container $c): UiDashboardController => new UiDashboardController(
            listEntities: $c->getTyped(ListEntitiesUseCase::class),
            listJournals: $c->getTyped(ListJournalsUseCase::class),
            fiscalTerms: $c->getTyped(\Rucaro\Support\Web\FiscalTermLookup::class),
            session: $c->getTyped(SessionStore::class),
            csrf: $c->getTyped(CsrfTokenManager::class),
            flash: $c->getTyped(FlashMessageBag::class),
            view: $c->getTyped(SmartyViewRenderer::class),
        ));
        $c->set(UiEntitySwitchController::class, static fn (Container $c): UiEntitySwitchController => new UiEntitySwitchController(
            session: $c->getTyped(SessionStore::class),
            csrf: $c->getTyped(CsrfTokenManager::class),
            flash: $c->getTyped(FlashMessageBag::class),
        ));
        ...
        $c->set(UiJournalUiContext::class, static fn (Container $c): UiJournalUiContext => new UiJournalUiContext(
            $c->getTyped(ListAccountTitlesUseCase::class),
            $c->getTyped(\PDO::class),
            $c->getTyped(SubAccountTitleRepositoryInterface::class),
            $c->getTyped(AccountTitleConsumptionTaxDefaultRepositoryInterface::class),
        ));
        $c->set(UiJournalListController::class, static fn (Container $c): UiJournalListController => new UiJournalListController(
            search: $c->getTyped(SearchJournalUseCase::class),
            uiContext: $c->getTyped(UiJournalUiContext::class),
            userDisplay: $c->getTyped(\Rucaro\Support\Web\UserDisplayLookup::class),
            session: $c->getTyped(SessionStore::class),
            csrf: $c->getTyped(CsrfTokenManager::class),
            flash: $c->getTyped(FlashMessageBag::class),
            view: $c->getTyped(SmartyViewRenderer::class),
        ));
        $c->set(UiJournalNewController::class, static fn (Container $c): UiJournalNewController => new UiJournalNewController(
        ...
        $c->set(UiJournalShowController::class, static fn (Container $c): UiJournalShowController => new UiJournalShowController(
            journals: $c->getTyped(JournalRepositoryInterface::class),
            uiContext: $c->getTyped(UiJournalUiContext::class),
            userDisplay: $c->getTyped(\Rucaro\Support\Web\UserDisplayLookup::class),
            session: $c->getTyped(SessionStore::class),
        ...
        $c->set(UiJournalEditController::class, static fn (Container $c): UiJournalEditController => new UiJournalEditController(
        ...
        $c->set(UiJournalDeleteController::class, static fn (Container $c): UiJournalDeleteController => new UiJournalDeleteController(
        ...
        $c->set(UiJournalApproveController::class, static fn (Container $c): UiJournalApproveController => new UiJournalApproveController(
            approveJournal: $c->getTyped(ApproveJournalUseCase::class),
            journals: $c->getTyped(JournalRepositoryInterface::class),
            session: $c->getTyped(SessionStore::class),
            csrf: $c->getTyped(CsrfTokenManager::class),
            flash: $c->getTyped(FlashMessageBag::class),
        ));
        $c->set(UiJournalPostController::class, static fn (Container $c): UiJournalPostController => new UiJournalPostController(
            postJournal: $c->getTyped(PostJournalUseCase::class),
            journals: $c->getTyped(JournalRepositoryInterface::class),
            session: $c->getTyped(SessionStore::class),
            csrf: $c->getTyped(CsrfTokenManager::class),
            flash: $c->getTyped(FlashMessageBag::class),
        ...
        $c->set(PeriodQueryHelper::class, static fn (Container $c): PeriodQueryHelper => new PeriodQueryHelper($c->getTyped(\PDO::class)));
        $c->set(UiLedgerViewController::class, static fn (Container $c): UiLedgerViewController => new UiLedgerViewController(
        ...
        $c->set(UiPlViewController::class, static fn (Container $c): UiPlViewController => new UiPlViewController(
            useCase: $c->getTyped(GenerateFinancialStatementUseCase::class),
        ...
        $c->set(UiBsViewController::class, static fn (Container $c): UiBsViewController => new UiBsViewController(
            useCase: $c->getTyped(GenerateFinancialStatementUseCase::class),
            pdfGenerator: $c->getTyped(FinancialStatementGeneratorInterface::class),
            period: $c->getTyped(PeriodQueryHelper::class),
            fiscalTerms: $c->getTyped(\Rucaro\Support\Web\FiscalTermLookup::class),
        ...
        // --- Phase B-5: Trial Balance Web UI (RC-9) ---
        $c->set(UiTrialBalanceViewController::class, static fn (Container $c): UiTrialBalanceViewController => new UiTrialBalanceViewController(
            useCase: $c->getTyped(QueryTrialBalanceUseCase::class),
            period: $c->getTyped(PeriodQueryHelper::class),
            fiscalTerms: $c->getTyped(\Rucaro\Support\Web\FiscalTermLookup::class),
            session: $c->getTyped(SessionStore::class),
            csrf: $c->getTyped(CsrfTokenManager::class),
        ...
        $c->set(UiCsViewController::class, static fn (Container $c): UiCsViewController => new UiCsViewController(
            useCase: $c->getTyped(GenerateFinancialStatementUseCase::class),
            pdfGenerator: $c->getTyped(FinancialStatementGeneratorInterface::class),
            period: $c->getTyped(PeriodQueryHelper::class),
            fiscalTerms: $c->getTyped(\Rucaro\Support\Web\FiscalTermLookup::class),
        ...
        $c->set(UiMultiPeriodFsViewController::class, static fn (Container $c): UiMultiPeriodFsViewController => new UiMultiPeriodFsViewController(
            useCase: $c->getTyped(GenerateMultiPeriodFinancialStatementUseCase::class),
        ...
        $c->set(UiBepViewController::class, static fn (Container $c): UiBepViewController => new UiBepViewController(
        ...
        $c->set(UiBlueReturnViewController::class, static fn (Container $c): UiBlueReturnViewController => new UiBlueReturnViewController(
        ...
        $c->set(UiSsViewController::class, static fn (Container $c): UiSsViewController => new UiSsViewController(
        ...
        $c->set(UiNotesListViewController::class, static fn (Container $c): UiNotesListViewController => new UiNotesListViewController(
        ...
        $c->set(CreateAccountTitleUseCase::class, static fn (Container $c): CreateAccountTitleUseCase => new CreateAccountTitleUseCase(
            repo: $c->getTyped(AccountTitleRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(UpdateAccountTitleUseCase::class, static fn (Container $c): UpdateAccountTitleUseCase => new UpdateAccountTitleUseCase(
            repo: $c->getTyped(AccountTitleRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(DeleteAccountTitleUseCase::class, static fn (Container $c): DeleteAccountTitleUseCase => new DeleteAccountTitleUseCase(
            repo: $c->getTyped(AccountTitleRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(CreateSubAccountTitleUseCase::class, static fn (Container $c): CreateSubAccountTitleUseCase => new CreateSubAccountTitleUseCase(
            repo: $c->getTyped(SubAccountTitleRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(UpdateSubAccountTitleUseCase::class, static fn (Container $c): UpdateSubAccountTitleUseCase => new UpdateSubAccountTitleUseCase(
            repo: $c->getTyped(SubAccountTitleRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(DeleteSubAccountTitleUseCase::class, static fn (Container $c): DeleteSubAccountTitleUseCase => new DeleteSubAccountTitleUseCase(
            repo: $c->getTyped(SubAccountTitleRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(CreateEntityUseCase::class, static fn (Container $c): CreateEntityUseCase => new CreateEntityUseCase(
            repo: $c->getTyped(EntityRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(UpdateEntityUseCase::class, static fn (Container $c): UpdateEntityUseCase => new UpdateEntityUseCase(
            repo: $c->getTyped(EntityRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(DeleteEntityUseCase::class, static fn (Container $c): DeleteEntityUseCase => new DeleteEntityUseCase(
            repo: $c->getTyped(EntityRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(CreateFiscalTermUseCase::class, static fn (Container $c): CreateFiscalTermUseCase => new CreateFiscalTermUseCase(
            repo: $c->getTyped(FiscalTermRepositoryInterface::class),
            ulids: $c->getTyped(UlidGenerator::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(UpdateFiscalTermUseCase::class, static fn (Container $c): UpdateFiscalTermUseCase => new UpdateFiscalTermUseCase(
            repo: $c->getTyped(FiscalTermRepositoryInterface::class),
            clock: $c->getTyped(ClockInterface::class),
        ));
        $c->set(DeleteFiscalTermUseCase::class, static fn (Container $c): DeleteFiscalTermUseCase => new DeleteFiscalTermUseCase(
            repo: $c->getTyped(FiscalTermRepositoryInterface::class),
        ));

        $c->set(UiMasterAccountTitleController::class, static fn (Container $c): UiMasterAccountTitleController => new UiMasterAccountTitleController(
        ...
        $c->set(UiMasterSubAccountTitleController::class, static fn (Container $c): UiMasterSubAccountTitleController => new UiMasterSubAccountTitleController(
            repo: $c->getTyped(SubAccountTitleRepositoryInterface::class),
        ...
        $c->set(UiMasterEntityController::class, static fn (Container $c): UiMasterEntityController => new UiMasterEntityController(
        ...
        $c->set(UiMasterFiscalTermController::class, static fn (Container $c): UiMasterFiscalTermController => new UiMasterFiscalTermController(
            repo: $c->getTyped(FiscalTermRepositoryInterface::class),
        ...
        $c->set(UiPlanningContext::class, static fn (Container $c): UiPlanningContext => new UiPlanningContext(
            $c->getTyped(ListAccountTitlesUseCase::class),
            $c->getTyped(\PDO::class),
        ));

        $c->set(UiFixedAssetListController::class, static fn (Container $c): UiFixedAssetListController => new UiFixedAssetListController(
        ...
        $c->set(UiFixedAssetNewController::class, static fn (Container $c): UiFixedAssetNewController => new UiFixedAssetNewController(
        ...
        $c->set(UiFixedAssetShowController::class, static fn (Container $c): UiFixedAssetShowController => new UiFixedAssetShowController(
        ...
        $c->set(UiFixedAssetEditController::class, static fn (Container $c): UiFixedAssetEditController => new UiFixedAssetEditController(
            updateAsset: $c->getTyped(UpdateFixedAssetUseCase::class),
            session: $c->getTyped(SessionStore::class),
            csrf: $c->getTyped(CsrfTokenManager::class),
            flash: $c->getTyped(FlashMessageBag::class),
        ));
        $c->set(UiFixedAssetDisposeController::class, static fn (Container $c): UiFixedAssetDisposeController => new UiFixedAssetDisposeController(
        ...
        $c->set(UiFixedAssetDepreciateController::class, static fn (Container $c): UiFixedAssetDepreciateController => new UiFixedAssetDepreciateController(
        ...
        $c->set(UiBudgetListController::class, static fn (Container $c): UiBudgetListController => new UiBudgetListController(
        ...
        $c->set(UiBudgetNewController::class, static fn (Container $c): UiBudgetNewController => new UiBudgetNewController(
        ...
        $c->set(UiBudgetShowController::class, static fn (Container $c): UiBudgetShowController => new UiBudgetShowController(
        ...
        $c->set(UiBudgetLifecycleController::class, static fn (Container $c): UiBudgetLifecycleController => new UiBudgetLifecycleController(
        ...
        $c->set(UiBudgetVarianceController::class, static fn (Container $c): UiBudgetVarianceController => new UiBudgetVarianceController(
            getBudget: $c->getTyped(GetBudgetUseCase::class),
        ...
        $c->set(UiCashPlanListController::class, static fn (Container $c): UiCashPlanListController => new UiCashPlanListController(
        ...
        $c->set(UiCashPlanNewController::class, static fn (Container $c): UiCashPlanNewController => new UiCashPlanNewController(
        ...
        $c->set(UiCashPlanShowController::class, static fn (Container $c): UiCashPlanShowController => new UiCashPlanShowController(
        ...
        $c->set(UiCashPlanDeleteController::class, static fn (Container $c): UiCashPlanDeleteController => new UiCashPlanDeleteController(
        ...
        $c->set(UiCtPeriodListController::class, static fn (Container $c): UiCtPeriodListController => new UiCtPeriodListController(
        ...
        $c->set(UiCtPeriodNewController::class, static fn (Container $c): UiCtPeriodNewController => new UiCtPeriodNewController(
        ...
        $c->set(UiCtPeriodShowController::class, static fn (Container $c): UiCtPeriodShowController => new UiCtPeriodShowController(
            periods: $c->getTyped(ConsumptionTaxPeriodRepositoryInterface::class),
            session: $c->getTyped(SessionStore::class),
            csrf: $c->getTyped(CsrfTokenManager::class),
            flash: $c->getTyped(FlashMessageBag::class),
        ...
        $c->set(UiCtCalculateController::class, static fn (Container $c): UiCtCalculateController => new UiCtCalculateController(
            calculate: $c->getTyped(CalculateConsumptionTaxUseCase::class),
        ...
        $c->set(UiCtAccountDefaultsController::class, static fn (Container $c): UiCtAccountDefaultsController => new UiCtAccountDefaultsController(
        ...
        $c->set(UiCtInvoiceRegistrationController::class, static fn (Container $c): UiCtInvoiceRegistrationController => new UiCtInvoiceRegistrationController(
        ...
        $c->set(UiSsAdjustmentListController::class, static fn (Container $c): UiSsAdjustmentListController => new UiSsAdjustmentListController(
        ...
        $c->set(UiSsAdjustmentNewController::class, static fn (Container $c): UiSsAdjustmentNewController => new UiSsAdjustmentNewController(
        ...
        $c->set(UiSsAdjustmentEditController::class, static fn (Container $c): UiSsAdjustmentEditController => new UiSsAdjustmentEditController(
        ...
        $c->set(UiSsAdjustmentDeleteController::class, static fn (Container $c): UiSsAdjustmentDeleteController => new UiSsAdjustmentDeleteController(
