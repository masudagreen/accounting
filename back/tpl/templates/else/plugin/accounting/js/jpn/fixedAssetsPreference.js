 ...
 * http://rucaro.org/
 */
var Code_Plugin_Accounting_FixedAssetsPreference = Class.create(Code_Lib_ExtPreference,
{
{/literal}
	vars : {$varsLoad},
	numNews : {$numNews},
	...
	*/
	_eventDetailConnect : function(obj)
	{
		if (obj.flag == 'reload' || obj.flag == 'output') {
			...
			if (obj.idTarget == 'flagDepWrite') {
				if (!vars.NumRatioOperateDepSum.match(/^[0-9]{1,3}\.[0-9]{2,2}$/)) {
