<?php /* Smarty version 3.1.24, created on 2019-10-06 10:05:04
         compiled from "/app/rucaro/back/tpl/templates/else/plugin/accounting/js/jpn/balance.js" */ ?>
<?php
/*%%SmartyHeaderCode:19632425415d99bc50bc5d55_07344155%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '883c49f4bcdaff3617d025097eeb59a2fa3ff9ac' => 
    array (
      0 => '/app/rucaro/back/tpl/templates/else/plugin/accounting/js/jpn/balance.js',
      1 => 1570328745,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19632425415d99bc50bc5d55_07344155',
  'variables' => 
  array (
    'varsLoad' => 0,
    'numNews' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_5d99bc50c20485_98216754',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5d99bc50c20485_98216754')) {
function content_5d99bc50c20485_98216754 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '19632425415d99bc50bc5d55_07344155';
?>
	...
	_getDetailChildVars : function(obj)
	{
		...
		for (var i = 0; i < obj.arr.length; i++) {
			if (obj.arr[i].id == 'DummyStatus') {
				...
				obj.arr[i].strCommentTitle += strTmpl.replace(RegExp("<?php echo '<%'; ?>
replace<?php echo '%>'; ?>
", "g"), str);
				arrayNew.push(obj.arr[i]);
