<?php /* Smarty version 3.1.24, created on 2016-08-23 08:57:55
         compiled from "/storage/emulated/0/htdocs/rucaro/back/tpl/templates/else/plugin/accounting/js/jpn/subAccountTitle.js" */ ?>
<?php
/*%%SmartyHeaderCode:31752564857bc10130c5d30_81620730%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0cce8350acfff24c76459f8616a4e9411cba962e' => 
    array (
      0 => '/storage/emulated/0/htdocs/rucaro/back/tpl/templates/else/plugin/accounting/js/jpn/subAccountTitle.js',
      1 => 1471523679,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '31752564857bc10130c5d30_81620730',
  'variables' => 
  array (
    'varsLoad' => 0,
    'numNews' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_57bc10132232d7_74302650',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_57bc10132232d7_74302650')) {
function content_57bc10132232d7_74302650 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '31752564857bc10130c5d30_81620730';
?>
 ...
 * http://rucaro.org/
 */
var Code_Plugin_Accounting_SubAccountTitle = Class.create(Code_Lib_ExtPortal,
{
	...
	*/
	bootAutoSearch : function(obj)
	{
		...
		if (str == 'arrSpaceStrTag') {
			...
			varsTmpl.strColumn = 'idSubAccountTitle';
			varsTmpl.value = obj.vars.vars[str];
			varsData.push(varsTmpl);

		} else if (str == 'dummyIdAccountTitle') {
			varsTmpl.flagType = 'fs';
			varsTmpl.strColumn = 'idAccountTitle';
			varsTmpl.value = obj.vars.vars[str];
			varsData.push(varsTmpl);
		}
	...
	_updateDetailListVarsChild : function(obj)
	{
		...
		for (var i = 0; i < obj.arr.length; i++) {
			...
			if (obj.arr[i].id == 'StampRegister') {
				...
				temp.vars = {};
				temp.vars[id] = obj.vars.vars.idAccountTitle;
