		...
		'varsNavi' => array(
			...
			'tree' => array(
				'varsFormat' => array(
					...
					'numWidth' => 0,
					'flagHeaderLeftUse' => 1,
					'strTitleHeaderLeft' => 'アカウントロックリスト',
		...
		'varsDetail' => array(
			...
			'templateDetail' => array(
				array(
					...
					'arrayError' => array(),
					'flagContentUse' => 0,
					'flagCommentUse' => 1, 'strCommentTitle' => '', 'strComment' => '【ロック対象者名】 <%strTitle%>、【ロック日時】 <%strTime%>',
					'flagTag' => 'input', 'flagInputType' => 'text', 'numMaxlength' => 0,
					'numWidth' => 80, 'unitWidth' => '%', 'numHeight' => 0, 'unitHeight' => '',
					'arrayOption' => array(),  
					'flagFoldUse' => 0, 'flagFoldNow' => 0,
				...
				array(
					'flagMustUse' => 1,
					'id' => 'IdLogin',
					'strTitle' => '新ログインID', 'strExplain' => 'ログインIDを新しいものに変更してください。<br>　※ 半角英数で記入してください。<br>　※ 5文字以上記入してください。<br>　※ 一度使用したことのあるログインIDは使えません。<br>　※ パスワードは自動で新しいものに変更されます。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						...
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array('idLogin' => '既存のログインIDと重複しているようです。', 'idLoginPast' => '一度使用したことのあるログインIDと重複しているようです。', 'term' => 'アカウントの有効期間がまだ到来していないか又は過ぎているようです。まずアカウントの有効期間を有効にし、次にロックを解除するか検討してください。',),),
					),
					'flagContentUse' => 0,
