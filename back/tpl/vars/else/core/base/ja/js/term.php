				...
				'varsDetail' => array(
					...
					'varsSearchSort' => array(
						...
						'itemOption' => array(
							...
							array( 'strTitle' => '開始日', 'value' => 'stampStart', ),
							array( 'strTitle' => '終了日', 'value' => 'stampEnd', ),
						),
						'sortOption' => array(
					...
					'varsSearchItem' => array(
						...
						'templateDetail' => array(
							...
							'firstOption' => array(
								...
								array( 'strTitle' => '開始日', 'value' => 'stamp-stampStart', ),
								array( 'strTitle' => '終了日', 'value' => 'stamp-stampEnd', ),
		...
		'varsDetail' => array(
			...
			'templateDetail' => array(
				...
				array(
					'flagMustUse' => 1,
					'id' => 'StrTitle',
					'strTitle' => 'タイトル', 'strExplain' => '当該有効期間のタイトル名を記入してください。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
				...
				array(
					'flagMustUse' => 1,
					'id' => 'StampStart',
					'strTitle' => '有効期間 - 開始年月日', 'strExplain' => '有効期間の開始年月日を設定してください。<br>　※ 設定例) 2010/1/1<br>　※ 2010/1/1と設定した場合、開始点は1月1日の0時0分0秒からとなります。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
				...
				array(
					'flagMustUse' => 0,
					'id' => 'StampEnd',
					'strTitle' => '有効期間 - 終了年月日', 'strExplain' => '有効期間の終了年月日を設定してください。<br>　※ 期限を設けない場合は空欄のままにしてください。<br>　※ 設定例) 2010/12/31<br>※2010/12/31と設定した場合、終了点は12月31日の23時59分59秒までとなります。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
						array( 'flagCheck' => 'format', 'flagUse' => 1, 'flagNow' => 0, 'flagArr' => 0, 'flagType' => 'date', 'strComment' => array( 'common' => '指定されたフォーマットに沿って記入されていないようです。',  ), ),
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array('common' => '終了と開始があべこべになっているようです。', ),),
					),
					'flagContentUse' => 0,
					'flagCommentUse' => 1, 'strCommentTitle' => '', 'strComment' => '',
					'flagTag' => 'input', 'flagInputType' => 'text', 'numMaxlength' => 10,
