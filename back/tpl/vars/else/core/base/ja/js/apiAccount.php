			...
			'search' => array(
				...
				'varsDetail' => array(
					'varsStatus' => array(
						...
						'idColumnWordList' => array('strSiteUrl', 'ip'),
					...
					'varsSearchItem' => array(
						...
						'templateDetail' => array(
							...
							'firstOption' => array(
								...
								array( 'strTitle' => 'プログラムURL', 'value' => 'str-strSiteUrl', ),
								array( 'strTitle' => 'アカウント/通番', 'value' => 'num-idAccount', ),
		...
		'varsDetail' => array(
			...
			'templateDetail' => array(
				array(
					'flagMustUse' => 1,
					'id' => 'Ip',
					'strTitle' => 'IP', 'strExplain' => 'APIを使ってアクセスしてくるIPアドレスを設定してください。',
					'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagArr' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '無記入項目があるようです。', ), ),
						array( 'flagCheck' => 'word', 'flagUse' => 1, 'flagNow' => 0, 'flagArr' => 0, 'flagType' => 'ip', 'strComment' => array( 'common' => 'IPで通常、予定されていない文字が含まれているようです。', ), ),
						array( 'flagCheck' => 'format', 'flagUse' => 1, 'flagNow' => 0, 'flagArr' => 0, 'flagType' => 'ip', 'strComment' => array( 'common' => 'IPのフォーマットにエラーがあるようです。', ), ),
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array(
							'sameData' => '重複しているデータが既に存在するようです。',
							'sameAccount' => '一つのIPに異なるアカウントは設定できないようです。',
						),),
					),
					'flagContentUse' => 0,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
				...
				array(
					'flagMustUse' => 1,
					'id' => 'StrSiteUrl',
					'strTitle' => 'プログラムURL', 'strExplain' => 'セッションIDを受け取るプログラムがあるURLを設定してください。', 'value' => 'https://',
					'flagErrorNow' => 0,
					'arrayError' => array(
				...
				array(
					'flagMustUse' => 1,
					'id' => 'IdAccount',
					'strTitle' => 'アカウント', 'strExplain' => '関連付けるアカウントを選択してください。',
					'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						...
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array(
							'idAccountCurrent' => '選択されたアカウントは、既に存在しないようです。',
						),),
					),
					'flagContentUse' => 1,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
