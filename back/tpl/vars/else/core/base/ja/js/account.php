					...
					'varsSearchItem' => array(
						...
						'templateDetail' => array(
							...
							'firstOption' => array(
								...
								array( 'strTitle' => '表示名', 'value' => 'str-strCodeName', ),
								array( 'strTitle' => 'ログインID', 'value' => 'str-idLogin', ),
								array( 'strTitle' => 'メール', 'value' => 'str-strMailPc', ),
								array( 'strTitle' => 'タグ', 'value' => 'tag-arrSpaceStrTag', ),
								array( 'strTitle' => '有効期間パターン/通番', 'value' => 'num-idTerm', ),
								array( 'strTitle' => 'モジュールパターン/通番', 'value' => 'num-idModule', ),
							),
							'tagOption' => array(
		...
		'varsDetail' => array(
			...
			'templateDetail' => array(
				array(
					...
					'arrayError' => array(),
					'flagContentUse' => 0,
					'flagCommentUse' => 1, 'strCommentTitle' => '', 'strComment' => 'このアカウントは、<span class="codeLibBaseFontTypeCheck" style="float:none;"> ウェブマスター </span> です。<br> システムを掌握するため 『 有効期間パターン 』 と 『 モジュールパターン 』 は変更できません。',
					'flagTag' => 'input', 'flagInputType' => 'text', 'numMaxlength' => 0,
				...
				array(
					...
					'arrayError' => array(),
					'flagContentUse' => 0,
					'flagCommentUse' => 1, 'strCommentTitle' => '', 'strComment' => '※ パスワードは、『<span class="codeLibBaseFontTypeCheck" style="float:none;"> メール認証手続後 </span>』に自動的に発行されます。',
					'flagTag' => 'input', 'flagInputType' => 'text', 'numMaxlength' => 0,
					'numWidth' => 80, 'unitWidth' => '%', 'numHeight' => 0, 'unitHeight' => '',
					'arrayOption' => array(), 
					'flagFoldUse' => 1, 'flagFoldNow' => 0,
				...
				array(
					'flagMustUse' => 1,
					'id' => 'StrCodeName',
					'strTitle' => '表示名', 'strExplain' => 'システム内で表示される名前を記入してください。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						...
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array('strCodeName' => '既存の表示名と重複しているようです。','strCodeNamePast' => '一度使用したことのある表示名と重複しているようです。',),),
				...
				array(
					...
					'arrayError' => array(
						...
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array('idLogin' => '既存のログインIDと重複しているようです。','idLoginPast' => '一度使用したことのあるログインIDと重複しているようです。',),),
					),
					'flagContentUse' => 0,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
					'flagTag' => 'input', 'flagInputType' => 'text', 'numMaxlength' => 100,
				...
				array(
					...
					'arrayError' => array(
						...
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array('strMailPc' => '既存のメールアドレスと重複しているようです。',),),
				...
				array(
					...
					'arrayError' => array(
						...
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array('strPassword' => '今まで使用したパスワードとは違う値にしなければならないようです。',),),
					),
					'flagContentUse' => 0,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
				...
				array(
					...
					'strTitle' => 'パスワード確認', 'strExplain' => '確認のため再度パスワードを入力してください。', 'value' => 'test',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array('common' => '記入漏れがあるようです。', ), ),
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array('common' => 'パスワードと一致しないようです。',),),
					),
					'flagContentUse' => 0,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
					'flagTag' => 'input', 'flagInputType' => 'password', 'numMaxlength' => 0,
				...
				array(
					'flagMustUse' => 1,
					'id' => 'IdTerm',
					'strTitle' => '有効期間パターン', 'strExplain' => 'ボタンを押して任意の有効期間パターンを一つ選択してください。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						...
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array('idTerm' => '選択された有効期間は、既に存在しないようです。',),),
					),
					'flagContentUse' => 1,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
					'flagTag' => 'input', 'flagInputType' => 'text', 'numMaxlength' => 200,
				...
				array(
					'flagMustUse' => 0,
					'id' => 'StrTerm',
					'strTitle' => '有効期間パターン', 'strExplain' => '', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
					),
					'flagContentUse' => 0,
				...
				array(
					'flagMustUse' => 1,
					'id' => 'IdModule',
					'strTitle' => 'モジュールパターン', 'strExplain' => 'ボタンを押して任意のモジュールパターンを一つ選択してください。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array('common' => '選択漏れがあるようです。', ), ),
						array( 'flagCheck' => 'word', 'flagUse' => 1, 'flagNow' => 0, 'flagArr' => 0, 'flagType' => 'num', 'strComment' => array('common' => '半角数字で記入されていないようです。', ), ),
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array('idModule' => '選択されたモジュールパターンは、既に存在しないようです。',),),
					),
					'flagContentUse' => 1,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
					'flagTag' => 'input', 'flagInputType' => 'text', 'numMaxlength' => 200,
				...
				array(
					'flagMustUse' => 0,
					'id' => 'StrModule',
					'strTitle' => 'モジュールパターン', 'strExplain' => '', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(),
					'flagContentUse' => 0,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
