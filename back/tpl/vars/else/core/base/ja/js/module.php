		...
		'varsDetail' => array(
			...
			'templateDetail' => array(
				...
				array(
					'flagMustUse' => 1,
					'id' => 'StrTitle',
					'strTitle' => 'タイトル', 'strExplain' => '当該モジュール構成のタイトル名を記入してください。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
				...
				array(
					'flagMustUse' => 1,
					'id' => 'JsonModule',
					'strTitle' => 'モジュール構成', 'strExplain' => 'アカウントに許可するモジュール構成を設定してください。<br>　※ 統制モジュールの管理者は全モジュールの管理者となります。<br>　※ 取捨選択できない項目は必須項目です。', 'value' => 'dummy',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
					),
