...
$vars = array(
	...
	'varsItem'  => array(
		...
		'varsWrite' => array(
			'strIdAccountTitle' => '既に陳腐化している勘定科目が使用されているため、書出しが見送られたようです。',
			'strIdDepartment' => '既に陳腐化している部門が使用されているため、書出しが見送られたようです。',
			'strIdSubAccountTitle' => '既に陳腐化している補助科目が使用されているため、書出しが見送られたようです。',
			'strData' => 'なんらかの原因でデータが壊れているため、書出しが見送られたようです。',
			'strPermit' => '既に設定変更等で陳腐化しているアカウントが承認者に含まれているため、書出しが見送られたようです。',
			'strSizeHistory' => '仕訳書出履歴の保存領域が限界に達したため履歴作成が見送られたようです。書出履歴が必要な場合は、新たなログを作成してください。',
		),
		...
		'strClassOver' => 'codeLibBaseFontBrown',
				...
				'varsDetail' => array(
						...
						'templateDetail' => array(
							...
							'logApply' => array(
								...
								'arrayOption' => array(
									...
									array( 'strTitle' => '決済処理済', 'value' => 'done', ),
									array( 'strTitle' => '未決済', 'value' => 'apply', ),
									array( 'strTitle' => '決済日到来', 'value' => 'over', ),
					...
					'varsSearchSort' => array(
						...
						'itemOption' => array(
							...
							array( 'strTitle' => '決済予定日時', 'value' => 'stampBook', ),
						),
						'sortOption' => array(
					...
					'varsSearchItem' => array(
						...
						'templateDetail' => array(
							...
							'firstOption' => array(
								array( 'strTitle' => '通番', 'value' => 'num-idLogCash', ),
								...
								array( 'strTitle' => '決済予定日時', 'value' => 'stamp-stampBook', ),
								array( 'strTitle' => '収支', 'value' => 'flagIn-flagIn-flagIn', ),
							...
							'restOption' => array(
								...
								'flagIn' => array(
									array( 'strTitle' => '収入', 'value' => 1, ),
									array( 'strTitle' => '支出', 'value' => 0, ),
									array( 'strTitle' => '移動', 'value' => 2, ),
								),
							),
						),
					),
		...
		'varsDetail' => array(
			...
			'templateDetail' => array(
				array(
					...
					'varsTmpl' => array(
						'strLost' => '※ 仕訳が不完全なため仕訳書出機能が無効になっています。エディタで仕訳情報を更新する必要があるようです。',
						'strPermitLost' => '※ 承認アカウントのアカウント情報が陳腐化しているため仕訳書出機能が無効になっています。エディタで最新のアカウント情報に更新する必要があるようです。',
						'strLostRemove' => '※ 勘定科目等が陳腐化し仕訳を正しく表示できないようです。',
					),
				),
				array(
					'flagMustUse' => 1,
					'id' => 'FlagIn',
					'strTitle' => '収支',
					'strExplain' => '収支を選択してください。<br>※移動を選択した場合は、資金が移動した金額を表示させるために収入と支出に金額が計上されます。',
					'value' => 0,
					'flagErrorNow' => 1,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入漏れがあるようです。', ),),
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array('spaceMax' => 'バージョン更新するための作業領域が足りないようです。当該仕訳は、削除扱いにして新しくログを作成してください。',),),
					),
					'flagContentUse' => 0,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
					'flagTag' => 'select', 'flagInputType' => '', 'numMaxlength' => 0,
				...
				array(
					...
					'strTitle' => '決済予定日時',
					'strExplain' => '
						決済予定日時を当期以後 (<%stampMin%> ～ ) に設定してください。
						<br>消費税設定が伴う場合は当期内 (<%stampMin%> ～ <%stampMax%>) に設定してください。
						<br>　※ 設定例) <%stampMin%>-12:00
						<br>　※ 半角英数で記入してください。
						',
					'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						...
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array(
							'term' => '当期より前の日時が設定されているか、カレンダーで表示されない日時が設定されているようです。',
							'termTax' => '書出仕訳に消費税設定が伴う場合は当期内の決済日時しか設定できないようです。',
						),),
					),
					'flagContentUse' => 0,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
				...
				array(
					'flagMustUse' => 1,
					'id' => 'JsonDetail',
					'strTitle' => '決済時 - 書出仕訳', 'strExplain' => '', 'value' => 'dummy',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array(
					...
					'varsFormJournal' => array(
						...
						'varsTmpl' => array(
							...
							'varsSelectTag' => array(
								...
								'varsBtnDictionaryIn' => array(),
								'varsBtnDictionaryOut' => array(),
								'varsBtnDictionaryMove' => array(),
							),
							'varsStrTitle' => array(
								'flagConsumptionTaxWithoutCalc' => array(
									'1' => '内税',
				...
				array(
					...
					'strTitle' => '決済時 - 書出仕訳 - 証憑ファイル', 'strExplain' => '決済書出仕訳に関連する証憑があれば選択してください。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
				...
				array(
					'flagMustUse' => 0,
					'id' => 'JsonFile',
					'strTitle' => '決済時 - 書出仕訳 - 証憑ファイル', 'strExplain' => '', 'value' => 'dummy',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
				...
				array(
					...
					'strTitle' => '決済時 - 書出仕訳 - 承認アカウント', 'strExplain' => '書出仕訳に対して承認を求める場合は任意のアカウントを選択してください。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
						array( 'flagCheck' => 'word', 'flagUse' => 1, 'flagNow' => 0, 'flagArr' => 'comma', 'flagType' => 'num', 'strComment' => array( 'common' => '予定されていない処理が起こりました。システムエラー。',  ), ),
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array(
							'attention' => '【 再確認 】担当者が承認アカウントに含まれているようです。',
				...
				array(
					...
					'strTitle' => '決済時 - 書出仕訳 - 承認アカウント', 'strExplain' => '', 'value' => 'dummy',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
					),
				...
				array(
					'flagMustUse' => 0,
					'id' => 'DummyStampBook',
					'strTitle' => '決済予定日時', 'strExplain' => '', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(),
					'flagContentUse' => 0,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
