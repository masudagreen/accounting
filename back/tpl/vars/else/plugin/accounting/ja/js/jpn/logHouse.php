...
$vars = array(
	...
	'varsItem'  => array(
		...
		'strClassZero' => 'codeLibBaseFontOrange',
		...
		'varsWrite' => array(
			...
			'strZero' => '対象科目の金額がゼロであるため、書出しが見送られたようです。',
				...
				'varsDetail' => array(
					...
					'varsSearchItem' => array(
						...
						'templateDetail' => array(
							...
							'firstOption' => array(
								array( 'strTitle' => '通番', 'value' => 'num-idLogHouse', ),
								...
								array( 'strTitle' => '家事割合', 'value' => 'str-numRatio', ),
								array( 'strTitle' => '勘定科目', 'value' => 'commaFs-arrCommaIdAccountTitleCredit-commaFs', ),
								array( 'strTitle' => '補助科目/通番', 'value' => 'comma-arrCommaIdSubAccountTitleCredit', ),
								array( 'strTitle' => '部門', 'value' => 'commaDepartment-arrCommaIdDepartmentCredit-commaDepartment', ),
								array( 'strTitle' => '税区分', 'value' => 'commaTax-arrCommaConsumptionTaxCredit-commaTax', ),
								array( 'strTitle' => '税率', 'value' => 'commaTaxRate-arrCommaRateConsumptionTaxCredit-commaTaxRate', ),
								array( 'strTitle' => '税入力', 'value' => 'commaTaxWithoutCalc-arrCommaConsumptionTaxWithoutCalcCredit-commaTaxWithoutCalc', ),
		...
		'varsDetail' => array(
			...
			'templateDetail' => array(
				array(
					...
					'varsTmpl' => array(
						'strIdLost' => '仕訳が不完全なため仕訳書出ができないようです。仕訳を再度修正設定する必要がありそうです。',
						'strPermitLost' => '承認アカウントのアカウント情報が陳腐化しているため仕訳書出ができないようです。承認アカウントを再度修正設定する必要がありそうです。',
						'strNumValueZero' => '家事按分の対象科目の金額がゼロなため仕訳書出ができないようです。',
					),
				),
				array(
					'flagMustUse' => 1,
					'id' => 'NumRatio',
					'strTitle' => '家事割合',
					'strExplain' => '家事割合を記入してください。<br>単位) %',
					'value' => '50.00',
					'flagErrorNow' => 0,
					'arrayError' => array(
				...
				array(
					'flagMustUse' => 0,
					'id' => 'StrTitle',
					'strTitle' => '書出仕訳摘要', 'strExplain' => '書出仕訳で摘要があれば記入してください。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
				...
				array(
					'flagMustUse' => 1,
					'id' => 'JsonDetail',
					'strTitle' => '書出仕訳', 'strExplain' => '※ 仕訳の金額は、家事割合に残高を掛けた金額は、登録保存した後に自動算出します。', 'value' => 'dummy',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array(
