					...
					'varsDetail' => array(
						array(
							...
							'child' => array(
									...
									'vars' => array(
										...
										'varsDetail' => array(
											array(
												'flagMustUse' => 1,
												'id' => 'JsonCash',
												'strTitle' => '資金範囲', 'strExplain' => '資金の範囲を選択してください。<br>※既に収支管理上で使用されている勘定科目は変更できません。<br>※複数選択可。', 'value' => '',
												'flagErrorNow' => 0,
												'arrayError' => array(
													array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '選択が必要なようです。', ),),
												),
												'flagContentUse' => 0,
												...
												'numSize' => 15,
												'varsTmpl' => array(
													'strDone'   => '<span class="codeLibBaseFontOrange" style="float:none;">※ データが確定しているため変更できません。</span>',
													'strTemp' => '<span class="codeLibBaseFontOrange" style="float:none;">※ 仮繰越処理中の会期がある間は変更できません。</span>',
													'strLog' => '<br><span class="codeLibBaseFontOrange" style="float:none;">※ 現在、選択している『 <%replace%> 』は既にシステム上で使用されているため変更できません。</span>',
													'strDoneItem' => '<br>現在選択しているのは、『 <%replace%> 』です。',
												),
											),
										),
									),
								...
								array(
									'id' => 'flagPayWrite', 'flagUse' => 1, 'flagMoveUse' => 1, 'flagInsertUse' => 1, 'flagBtnUse' => 1, 'flagFoldUse' => 0, 'flagFoldNow' => 0, 'flagChildrenUse' => 0, 'flagCheckUse' => 0, 'flagCheckNow' => 0, 'flagRemoveUse' => 1, 'flagEditUse' => 1,
									'strTitle' => '決済処理',
									'strClass' => 'codeLibBaseImgSheet',
									'vars' => array(
										'idTarget' => 'flagPayWrite', 'flagAccessUse' => 0, 'flagAllUse' => 1,
										'varsEdit' => array( 'flagReloadUse' => 1, ),
										'varsBtn' => array(
											array(
												'flagUse' => 1, 'flagLeftUse' => 0, 'flagRightUse' => 1, 'flagTextUse' => 0, 'flagBtnUse' => 1,
												'id' => 'flagPayWrite',
												'vars' => array( 'idTarget' => 'flagPayWrite',  ),
												'strTitle' => '保存',
											),
										),
										'varsDetail' => array(
											array(
												...
												'id' => 'FlagPayWrite',
												'strTitle' => '決済処理ボタン',
												'strExplain' => '決済処理ボタンをクリックした時に仕訳書き出しを同時に行うか選択してください。',
												'value' => 1,
												'flagErrorNow' => 0,
												'arrayError' => array(
												...
												'numWidth' => 40, 'unitWidth' => '%', 'numHeight' => 0, 'unitHeight' => '',
												'arrayOption' => array(
													array( 'strTitle' => '同時に行う', 'value' => 1, ),
													array( 'strTitle' => '別々で行う', 'value' => 0, ),
												),
												'flagDisabled' => 0,
												'varsTmpl' => array(
													'strDone'   => '<span class="codeLibBaseFontOrange" style="float:none;">※ データが確定しているため変更できません。</span>',
								...
								array(
									'id' => 'flagAutoImport', 'flagUse' => 1, 'flagMoveUse' => 1, 'flagInsertUse' => 1, 'flagBtnUse' => 1, 'flagFoldUse' => 0, 'flagFoldNow' => 0, 'flagChildrenUse' => 0, 'flagCheckUse' => 0, 'flagCheckNow' => 0, 'flagRemoveUse' => 1, 'flagEditUse' => 1,
									'strTitle' => '仕訳帳連携',
									'strClass' => 'codeLibBaseImgSheet',
									'vars' => array(
										'idTarget' => 'flagAutoImport', 'flagAccessUse' => 0, 'flagAllUse' => 1,
										'varsEdit' => array( 'flagReloadUse' => 1, ),
										'varsBtn' => array(
											array(
												'flagUse' => 1, 'flagLeftUse' => 0, 'flagRightUse' => 1, 'flagTextUse' => 0, 'flagBtnUse' => 1,
												'id' => 'flagAutoImport',
												'vars' => array( 'idTarget' => 'flagAutoImport',  ),
												'strTitle' => '保存',
											),
										),
										'varsDetail' => array(
											array(
												...
												'id' => 'FlagAutoImport',
												'strTitle' => '仕訳帳連携',
												'strExplain' => '仕訳帳で仕訳が新規作成された時に、収支管理と自動連携するか選択してください。<br><span class="codeLibBaseFontOrange" style="float:none;">※新規の期中仕訳のみ自動連携します。新規で中間・年度決算整理仕訳を作成する場合や仕訳を修正または削除扱いにする場合は自動連携しません。</span">',
												'value' => 1,
												'flagErrorNow' => 0,
												'arrayError' => array(
													array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入漏れがあるようです。', ),),
												...
												'numWidth' => 40, 'unitWidth' => '%', 'numHeight' => 0, 'unitHeight' => '',
												'arrayOption' => array(
													array( 'strTitle' => '自動連携する', 'value' => 1, ),
													array( 'strTitle' => '自動連携しない', 'value' => 0, ),
												),
												'flagDisabled' => 0,
												'varsTmpl' => array(
													'strDone'   => '<span class="codeLibBaseFontOrange" style="float:none;">※ データが確定しているため変更できません。</span>',
											...
											array(
												...
												'id' => 'FlagPermitImport',
												'strTitle' => '優先処理',
												'strExplain' => '仕訳帳と自動連携する場合、どちらの設定を優先するか選択してください。',
												'value' => 1,
												'flagErrorNow' => 0,
												'arrayError' => array(
													array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入漏れがあるようです。', ),),
												...
												'numWidth' => 40, 'unitWidth' => '%', 'numHeight' => 0, 'unitHeight' => '',
												'arrayOption' => array(
													array( 'strTitle' => '仕訳帳の設定', 'value' => 1, ),
													array( 'strTitle' => '収支管理の設定', 'value' => 0, ),
												),
												'flagDisabled' => 0,
												'varsTmpl' => array(
													'strDone'   => '<span class="codeLibBaseFontOrange" style="float:none;">※ データが確定しているため変更できません。</span>',
