			...
			'tree' => array(
				...
				'varsDetail' => array(
					...
					'varsDetail' => array(
							...
							'vars' => array(
								...
								'varsDetail' => array(
									array(
										...
										'id' => 'FlagAutoImport',
										'strTitle' => '仕訳帳連携',
										'strExplain' => '口座管理で新規ログが作成された場合、仕訳帳と自動的に連携して仕訳書出をするか選択してください。',
										'value' => 1,
										'flagErrorNow' => 0,
										'arrayError' => array(
						...
						/*
						array(
							'id' => 'flagLock', 'flagUse' => 1, 'flagMoveUse' => 1, 'flagInsertUse' => 1, 'flagBtnUse' => 1, 'flagFoldUse' => 0, 'flagFoldNow' => 0, 'flagChildrenUse' => 0, 'flagCheckUse' => 0, 'flagCheckNow' => 0, 'flagRemoveUse' => 1, 'flagEditUse' => 1,
							'strTitle' => 'WEB明細自動取得停止',
							'strClass' => 'codeLibBaseImgSheet',
							'vars' => array(
								'idTarget' => 'flagLock', 'flagAccessUse' => 0, 'flagAllUse' => 1,
								'varsEdit' => array( 'flagReloadUse' => 1, ),
								'varsBtn' => array(
									array(
										'flagUse' => 1, 'flagLeftUse' => 0, 'flagRightUse' => 1, 'flagTextUse' => 0, 'flagBtnUse' => 1,
										'id' => 'flagLock',
										'vars' => array( 'idTarget' => 'flagLock',  ),
										'strTitle' => '保存',
									),
								),
								'varsDetail' => array(
									array(
										...
										'id' => 'FlagLock',
										'strTitle' => 'WEB明細自動取得停止',
										'strExplain' => 'すべての金融機関のWEB明細の自動取得を停止することができます。',
										'value' => 1,
										'flagErrorNow' => 0,
										'arrayError' => array(
											array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入漏れがあるようです。', ),),
										...
										'numWidth' => 40, 'unitWidth' => '%', 'numHeight' => 0, 'unitHeight' => '',
										'arrayOption' => array(
											array('strTitle' => '自動取得を停止しない', 'value' => 0,),
											array('strTitle' => '自動取得を停止する', 'value' => 1,),
										),
										'flagDisabled' => 0,
										'varsTmpl' => array(
											'strDone'   => '<span class="codeLibBaseFontOrange" style="float:none;">※ データが確定しているため変更できません。</span>',
						...
						*/
						array(
							...
							'vars' => array(
								'idTarget' => 'banksAccountWindow', 'flagAccessUse' => 1, 'flagAllUse' => 1,
							),
							'child' => array(),
						),
					),
