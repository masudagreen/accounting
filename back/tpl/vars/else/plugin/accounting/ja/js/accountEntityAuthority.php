			...
			'search' => array(
				...
				'varsDetail' => array(
					'varsStatus' => array(
						...
						'flagTagUse' => 1,
						'flagMyRecordUse' => 1,
						'idColumnTagList' => array('baseAccount.arrSpaceStrTag'),
						'idColumnWordList' => array('baseAccount.strCodeName'),
					...
					'varsSearchSort' => array(
						...
						'varsDetail' => array(
							'id' => 0,
							'itemValue' => 'baseAccount.id',
							'sortValue' => 'desc'
						),
						'itemOption' => array(
							array( 'strTitle' => '記録日時', 'value' => 'baseAccount.id', ),
							array( 'strTitle' => '更新日時', 'value' => 'baseAccount.stampUpdate', ),
						),
						'sortOption' => array(
					...
					'varsSearchItem' => array(
						...
						'templateDetail' => array(
							...
							'firstOption' => array(
								array( 'strTitle' => '通番', 'value' => 'num-baseAccount.id', ),
								array( 'strTitle' => '記録日時', 'value' => 'stamp-baseAccount.stampRegister', ),
								array( 'strTitle' => '更新日時', 'value' => 'stamp-baseAccount.stampUpdate', ),
								array( 'strTitle' => '表示名', 'value' => 'str-baseAccount.strCodeName', ),
								array( 'strTitle' => 'アクセス権限パターン/通番', 'value' => 'num-idAuthority', ),
								array( 'strTitle' => 'アクセス可能項目パターン/通番', 'value' => 'num-idAccess', ),
								array( 'strTitle' => 'タグ', 'value' => 'tag-baseAccount.arrSpaceStrTag', ),
							),
							'tagOption' => array(
		...
		'varsDetail' => array(
			...
			'templateDetail' => array(
				array(
					...
					'strTitle' => '【お知らせ】',
					'strExplain' => '',
					'value' => '<span class="codeLibBaseFontOrange" style="float:none;">※ 管理者のアクセス権は変更できません。</span>',
					'flagErrorNow' => 0,
					'arrayError' => array(),
					'flagContentUse' => 0,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
				...
				array(
					'flagMustUse' => 0,
					'id' => 'StrTitle',
					'strTitle' => '表示名', 'strExplain' => '', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
					),
					'flagContentUse' => 0,
					'flagCommentUse' => 1, 'strCommentTitle' => '表示名', 'strComment' => '<span class="codeLibBaseFontTypeCheck" style="float:none;"> <%strTitle%> </span>',
					'flagTag' => 'input', 'flagInputType' => 'text', 'numMaxlength' => 100,
				...
				array(
					'flagMustUse' => 1,
					'id' => 'IdAuthority',
					'strTitle' => 'アクセス権限パターン', 'strExplain' => 'アクセス権限パターンを設定してください。', 'value' => 'dummy',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
					),
					...
					'varsChoice' => array(
						'idTarget' => 'PluginAccountingAuthority', 'idModule' => 'Accounting', 'flagCheckUse' => 0,
					),
				),
				array(
					'flagMustUse' => 0,
					'id' => 'DummyAuthority',
					'strTitle' => 'アクセス権限パターン', 'strExplain' => '', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
					),
					'flagContentUse' => 0,
				...
				array(
					'flagMustUse' => 1,
					'id' => 'IdAccess',
					'strTitle' => 'アクセス可能項目パターン', 'strExplain' => 'アクセス可能項目パターンを設定してください。', 'value' => 'dummy',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array( 'common' => '記入が必要なようです。', ),),
					),
					...
					'varsChoice' => array(
						'idTarget' => 'PluginAccountingAccess', 'idModule' => 'Accounting', 'flagCheckUse' => 0,
					),
				),
				array(
					'flagMustUse' => 0,
					'id' => 'DummyAccess',
					'strTitle' => 'アクセス可能項目パターン', 'strExplain' => '', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
					),
					'flagContentUse' => 0,
