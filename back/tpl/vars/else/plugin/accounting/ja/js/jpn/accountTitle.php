				...
				'varsDetail' => array(
					...
					'varsColumn' => array(
						...
						array(
							...
							'flagCheckUse' => 1,
							'flagCheckNow' => 1,
							'id' => 'FlagConsumptionTaxSimpleRule',
							'strTitle' => '簡易課税区分',
							'numSort' => 4,
							'numWidth' => 100,
							'numWidthMin' => 26,
		...
		'varsDetail' => array(
			...
			'templateDetail' => array(
				array(
					'flagMustUse' => 1,
					'id' => 'StrTitle',
					'strTitle' => '勘定科目名', 'strExplain' => '勘定科目名を記入してください。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
						array( 'flagCheck' => 'blank', 'flagUse' => 1, 'flagNow' => 0, 'flagType' => 'empty', 'strComment' => array('common' => '記入漏れがあるようです。', ), ),
						...
						array( 'flagCheck' => 'attest', 'flagUse' => 1, 'strComment' => array(
							'strTitle' => '既存の勘定科目名と重複しているようです。',
							'strTitleTempNext' => '次期において既存の勘定科目名と重複しているようです。',
						),),
					),
					'flagContentUse' => 0,
					'flagCommentUse' => 0, 'strCommentTitle' => '', 'strComment' => '',
				...
				array(
					...
					'flagDisabled' => 0,
					'varsTmpl' => array(
						'strNormal' => '勘定科目を識別するために固有の識別子を記入してください。<br>　※ 半角英数で記入してください。',
						'strDefault' => '<span class="codeLibBaseFontOrange" style="float:none;">※ システム上、デフォルトの識別子は変更できません。</span>',
						'strCash' => '<span class="codeLibBaseFontOrange" style="float:none;">※ 設定値が既にシステム上で使用されているため変更できません。</span>',
				...
				array(
					...
					'varsTmpl' => array(
						...
						'strDefault' => '<span class="codeLibBaseFontOrange" style="float:none;">※ システム上、デフォルトの貸借区分は変更できません。</span><br>現在選択しているのは、『 <%replace%> 』です。',
				...
				array(
					...
					'strTitle' => '勘定科目配置', 'strExplain' => 'アイコンをドラッグ＆ドロップし、新しい勘定科目の配置(整列)を設定してください。', 'value' => '',
					'flagErrorNow' => 0,
					'arrayError' => array(
				...
				array(
					'flagMustUse' => 0,
					'id' => 'DummyStrAccountTitleJgaapFS',
					'strTitle' => '決算科目',
					'strExplain' => '',
					'value' => 0,
					'flagErrorNow' => 0,
				...
				array(
					...
					'flagDisabled' => 0,
					'varsTmpl' => array(
						'strNormal' => '集計する決算科目を設定してください。',
						'strDefault' => '<span class="codeLibBaseFontOrange" style="float:none;">※ システム上、デフォルトの設定から変更できません。</span><br>現在選択しているのは、『 <%replace%> 』です。',
				...
				array(
					'flagMustUse' => 0,
					'id' => 'DummyFlagConsumptionTaxGeneralRule',
					'strTitle' => '本則課税区分',
					'strExplain' => '',
					'value' => '対象外',
					'flagErrorNow' => 0,
				...
				array(
					'flagMustUse' => 0,
					'id' => 'DummyFlagConsumptionTaxSimpleRule',
					'strTitle' => '簡易課税区分',
					'strExplain' => '',
					'value' => '対象外',
					'flagErrorNow' => 0,
				...
				array(
					...
					'flagDisabled' => 0,
					'varsTmpl' => array(
						'strNormal' => '元帳や試算表等で当該勘定科目を含めて出力表示するか否かを設定してください。',
					),
				),
			),
			'varsPage' => array(),
