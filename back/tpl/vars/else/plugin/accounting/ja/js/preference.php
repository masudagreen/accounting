									...
									'vars' => array(
										...
										'varsDetail' => array(
											array(
												'flagMustUse' => 0,
												'id' => 'JsonFileType',
												'strTitle' => '証憑ファイル拡張子', 'strExplain' => '証憑ファイルをアップロードする際、アップロードを許可する拡張子を設定してください。<br>　※ 半角英数で記入してください。', 'value' => '',
												'flagErrorNow' => 0,
												'arrayError' => array(
							...
							'vars' => array(
								...
								'varsDetail' => array(
									array(
										'flagMustUse' => 1,
										'id' => 'IdEntityCurrent',
										'strTitle' => '事業体', 'strExplain' => '作業する任意の事業体を一つ選択してください。<br>　※ 設定後、ページを<span class="codeLibBaseFontTypeCheck" style="float:none;">自動更新</span>します。', 'value' => '',
										'flagErrorNow' => 0,
										'arrayError' => array(
			...
			'varsEnd' => array(
				...
				'varsDetail' => array(
					array(
						...
						'flagTag' => 'input', 'flagInputType' => 'text', 'numMaxlength' => 0,
						'numWidth' => 80, 'unitWidth' => '%', 'numHeight' => 0, 'unitHeight' => '',
						'arrayOption' => array(), 'numOptionMust' => 0,
