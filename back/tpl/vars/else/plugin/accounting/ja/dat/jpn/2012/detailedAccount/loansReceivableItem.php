...
$vars = array(
	...
	'varsTmpl' => array(
		'detail' => array(
			...
			'varsTextValueReceived' => array(
				'flagMustUse' => 0,
				'id' => 'TextValueReceived',
				'strTitle' => '',
				'value' => '', 'valueStr' => '', 'flagValueType' => 'num',
				'flagErrorNow' => 0,
				'arrayError' => array(
	...
	'varsStr' => array(
		'detail' => array(
			...
			'strTitleExt' => '仮払金（前渡金）の内訳書　貸付金及び受取利息の内訳書',
			'strTitleSub' => '',
			'strEntityExt' => '',
			'strNumExt' => '',
			'strPageExt' => '',
			...
			'strUnit' => '(単位：円)',
			'strSeparate' => '/',
			'strCautionLaw' => '(法0302－4)',
			'strCautionMark' => '(注)',
			'strCaution1' => '１．相手先別期末現在高が50万円以上のものについては各別に記入し、その他は一括して記入してください。ただし、役員、株主及び関係会社については、期末現在高が50万円未満であってもすべて各別に記入してください。',
			'strCaution2' => '２．期末現在高がないものにあっても期中の受取利息額(未収利息を含みます。)が3万円以上あるものについては、各別に記入してください。',
			'strCaution3' => '３．「利率」欄には、同一の貸付先に対する利率が2以上ある場合には、そのうち期末に近い時期における受取利息の利率を記入してください。',
		),
		'analyze' => array(
			'strTitle' => '貸付金及び受取利息の内訳書',
