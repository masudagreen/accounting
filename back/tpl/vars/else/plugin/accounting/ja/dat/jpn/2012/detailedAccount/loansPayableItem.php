...
$vars = array(
	...
	'varsStr' => array(
		'detail' => array(
			...
			'strAddress' => '所在地(住所)',
			'strValue' => '期末現在高',
			'strValuePayable' => '期中の支払利子額',
			'strRate' => '利率',
			'strReason' => '借入理由',
			'strMemo' => '担保の内容(物件の種類、数量、所在地等)',

			'strMemoTop' => '担保の内容',
			'strMemoBottom' => '(物件の種類、数量、所在地等)',
			...
			'strUnit' => '(単位：円)',
			'strSeparate' => '/',
			'strCautionLaw' => '(法0302－11)',
			'strCautionMark' => '(注)',
			'strCaution1' => '１．相手先別期末現在高が50万円以上のものについては各別に記入し、その他は一括して記入してください。ただし、役員、株主及び関係会社については、期末現在高が50万円未満であってもすべて各別に記入してください。',
			'strCaution2' => '２．期末現在高がないものであっても期中の支払利子額(未払利子を含みます。)が3万円以上あるものについては、各別に記入してください。',
			'strCaution3' => '３．「利率」欄には、同一の借入先に対する利率が2 以上ある場合には、そのうち期末に近い時期における支払利子の利率を記入してください。',
			'strCaution4' => '４．外国法人又は非居住者から借り入れたものについては、「所在地(住所)」欄には、国外の所在地(住所)を記入してください。',
		),
		'analyze' => array(
			'strTitle' => '借入金及び支払利子の内訳書',
