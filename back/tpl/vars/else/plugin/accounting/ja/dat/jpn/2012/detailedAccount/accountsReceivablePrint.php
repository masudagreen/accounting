...
$vars = array(
	...
	'tmplColumn' => '
		<tr valign="middle">
			<td class="codeLibPrintMiddle" rowspan=2 style="width:120px;" >{$strAccountTitle}</td>
			<td class="codeLibPrintMiddle" colspan=2 style="width:410px;">{$strTarget}</td>
			<td class="codeLibPrintMiddle" rowspan=2 style="width:100px;">{$strValue}</td>
			<td class="codeLibPrintMiddle" rowspan=2 style="width:120px;">{$strMemo}</td>
		</tr>
		<tr valign="middle">
