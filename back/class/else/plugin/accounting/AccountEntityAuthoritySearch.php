 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_AccountEntityAuthoritySearch extends Code_Else_Plugin_Accounting_AccountEntityAuthority
{
	protected $_childSelf = array(
		'pathTplJs'  => 'else/plugin/accounting/js/accountEntityAuthoritySearch.js',
		'pathVarsJs' => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/accountEntityAuthoritySearch.php',
	);
	...
	protected function _iniJs()
	{
		$this->_setJs(array(
			...
			'strColumnSearch'   => 'jsonAccountEntityAuthorityNaviSearch',
			'flagEntitySearch'  => 1,
			'flagAccountSearch' => 1,
			'arrSearch'       => array(),
		));
