 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_AccessChoice extends Code_Else_Plugin_Accounting_Access
{
	...
	protected $_extSelf = array(
		'pathTplJs'          => 'else/plugin/accounting/js/accessChoice.js',
		'pathVarsJs'         => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/accessChoice.php',
	...
	protected function _iniJs()
	{
		$this->_setJs(array(
			...
			'strColumnSearch'   => 'jsonAccessNaviSearch',
			'flagEntitySearch'  => 0,
			'flagAccountSearch' => 1,
			'arrSearch'       => array(
				'idModule'  => 'accounting',
	...
	protected function _updateSearch($arr)
	{
		...
		foreach ($array as $key => $value) {
			...
			$var['id'] = $array[$key]['idAccess'];
			$var['vars']['idTarget'] = $array[$key]['idAccess'];
