 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_EntityDepartmentSearch extends Code_Else_Plugin_Accounting_Jpn_EntityDepartment
{
	protected $_childSelf = array(
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/entityDepartmentSearch.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/entityDepartmentSearch.php',
	);
	...
	protected function _iniJs()
	{
		$this->_setJs(array(
			...
			'strColumnSearch'   => 'jsonEntityDepartmentNaviSearch',
			'flagEntitySearch'  => 1,
			'flagAccountSearch' => 1,
			'arrSearch'         => array(),
		));
