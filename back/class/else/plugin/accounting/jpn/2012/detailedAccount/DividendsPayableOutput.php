 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_DividendsPayableOutput extends Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_DividendsPayable
{
	protected $_childSelf = array(
		'pathVarsPrint' => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/dividendsPayablePrint.php',
	);
	...
	protected function _getVarsPrint($arr)
	{
		...
		$class09Output = $this->_getClassExtra(array('strClass' => '09Output'));
		$varsPrint = $class09Output->allot(array(
			'flagStatus'      => 'print',
	...
	protected function _getVarsLoopCsv($arr)
	{
		...
		if ($arr['flagFirst']) {
			...
			$rowData = array();
			$rowData[] = $arr['varsData']['strDecision'];
			$rowData[] = '';
			$rowData[] = '';
