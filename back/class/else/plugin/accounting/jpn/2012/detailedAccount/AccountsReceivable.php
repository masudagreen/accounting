 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_AccountsReceivable extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountAccountsReceivableWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'accountsReceivable',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/accountsReceivable.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/accountsReceivable.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/accountsReceivableItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/accountsReceivable<%replace%>.html',
	);
