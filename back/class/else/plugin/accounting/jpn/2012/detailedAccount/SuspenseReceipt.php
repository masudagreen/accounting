 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_SuspenseReceipt extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountSuspenseReceiptWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'suspenseReceipt',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/suspenseReceipt.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/suspenseReceipt.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/suspenseReceiptItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/suspenseReceipt<%replace%>.html',
	);
