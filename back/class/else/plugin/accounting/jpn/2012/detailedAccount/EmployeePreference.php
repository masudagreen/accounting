 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_EmployeePreference extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountEmployeeWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'employee',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/employeePreference.js',
	...
	protected function _updateDbNumPageMax($arr)
	{
		...
		foreach ($arrayStr as $keyStr => $valueStr) {
			$this->_updateDbPage(array(
				...
				'flagDetail'      => $this->_extSelf['flagDetail'],
				'flagMenu'        => 'detail',
				'numRows'         => $varsCommon['varsStr']['detail']['numRowsLabor'],
				'valueStr'        => $valueStr,
			));
		}
	}
