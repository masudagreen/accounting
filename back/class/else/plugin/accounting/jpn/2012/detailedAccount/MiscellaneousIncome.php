 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_MiscellaneousIncome extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountMiscellaneousIncomeWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'miscellaneousIncome',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/miscellaneousIncome.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/miscellaneousIncome.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/miscellaneousIncomeItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/miscellaneousIncome<%replace%>.html',
	);
