 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_DividendsPayable extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountDividendsPayableWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'dividendsPayable',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/dividendsPayable.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/dividendsPayable.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/dividendsPayableItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/dividendsPayable<%replace%>.html',
	);
