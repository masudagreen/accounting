 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_AccountsPayable extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountAccountsPayableWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'accountsPayable',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/accountsPayable.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/accountsPayable.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/accountsPayableItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/accountsPayable<%replace%>.html',
	);
