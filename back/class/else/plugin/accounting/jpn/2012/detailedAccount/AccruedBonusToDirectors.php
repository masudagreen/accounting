 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_AccruedBonusToDirectors extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountAccruedBonusToDirectorsWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'accruedBonusToDirectors',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/accruedBonusToDirectors.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/accruedBonusToDirectors.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/accruedBonusToDirectorsItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/accruedBonusToDirectors<%replace%>.html',
	);
