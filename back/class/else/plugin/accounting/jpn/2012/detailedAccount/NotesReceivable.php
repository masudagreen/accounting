 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_NotesReceivable extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountNotesReceivableWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'notesReceivable',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/notesReceivable.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/notesReceivable.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/notesReceivableItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/notesReceivable<%replace%>.html',
	);
