 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_10Output extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extChildSelf = array(
		'pathVarsPrint' => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/10Print.php',
	);
	...
	protected function _getVarsItem($arr)
	{
		...
		$varsStatus['suspenseReceipt'] = array(
			'pathItem' => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/suspenseReceiptItem.php',
		);
		$varsStatus['incomeTaxWithholding'] = array(
			'pathItem' => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/incomeTaxWithholdingItem.php',
		);
	...
	protected function _getVarsLoopPrint($arr)
	{
		...
		$flagStage = 'incomeTaxWithholding';
		$varsValue = $arr['varsItem']['varsSave'][$flagStage]['jsonData'][$flagMenu];
		...
		for ($i = 1; $i <= $numAll; $i++) {
			...
			$tmplRow['strRow'] = $this->_getVarsHtml(array(
				'varsData' => $arr['varsData'],
				'value'    => $varsStr,
				'tmplStr'  => $varsPrintItem['tmplRow']['tmplTr1' . ucwords($flagStage)],
			));
			$varsPrint['varsDetail'][] = $tmplRow;
		}
