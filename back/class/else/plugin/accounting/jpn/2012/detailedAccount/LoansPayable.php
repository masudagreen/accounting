 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_LoansPayable extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountLoansPayableWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'loansPayable',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/loansPayable.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/loansPayable.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/loansPayableItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/loansPayable<%replace%>.html',
	);
	...
	protected function _getDetailVarsDetail($arr)
	{
		...
		$tmplList = $array['varsTextSumPayable'];
		$tmplList['idTarget'] = 'value' . $tmplList['id'];
		$varsData['str' . $tmplList['id']] = $tmplList['strTitle'];
		$dataValue = $arr['varsValue'][$tmplList['idTarget']];
		if (!is_null($dataValue)) {
