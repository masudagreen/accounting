 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_Sales extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountSalesWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'sales',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/sales.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/sales.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/salesItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/sales<%replace%>.html',
	);
