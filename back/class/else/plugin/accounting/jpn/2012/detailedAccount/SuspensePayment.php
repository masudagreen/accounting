 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_SuspensePayment extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountSuspensePaymentWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'suspensePayment',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/suspensePayment.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/suspensePayment.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/suspensePaymentItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/suspensePayment<%replace%>.html',
	);
