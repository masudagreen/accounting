 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_KeyMoney extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountKeyMoneyWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'keyMoney',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/keyMoney.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/keyMoney.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/keyMoneyItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/keyMoney<%replace%>.html',
	);
