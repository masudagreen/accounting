 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_NotesPayable extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountNotesPayableWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'notesPayable',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/notesPayable.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/notesPayable.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/notesPayableItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/notesPayable<%replace%>.html',
	);
