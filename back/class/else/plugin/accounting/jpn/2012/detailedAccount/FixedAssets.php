 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_FixedAssets extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountFixedAssetsWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'fixedAssets',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/fixedAssets.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/fixedAssets.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/fixedAssetsItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/fixedAssets<%replace%>.html',
	);
