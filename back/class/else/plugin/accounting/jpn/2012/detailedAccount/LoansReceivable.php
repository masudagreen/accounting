 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_LoansReceivable extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountLoansReceivableWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'loansReceivable',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/loansReceivable.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/loansReceivable.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/loansReceivableItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/loansReceivable<%replace%>.html',
	);
	...
	protected function _getDetailVarsDetail($arr)
	{
		...
		$tmplList = $array['varsTextSumReceived'];
		$tmplList['idTarget'] = 'value' . $tmplList['id'];
		$varsData['str' . $tmplList['id']] = $tmplList['strTitle'];
		$dataValue = $arr['varsValue'][$tmplList['idTarget']];
		if (!is_null($dataValue)) {
