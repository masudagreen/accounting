 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_Rents extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountRentsWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'rents',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/rents.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/rents.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/rentsItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/rents<%replace%>.html',
	);
