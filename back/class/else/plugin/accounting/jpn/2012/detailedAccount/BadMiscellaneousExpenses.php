 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_BadMiscellaneousExpenses extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountBadMiscellaneousExpensesWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'badMiscellaneousExpenses',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/badMiscellaneousExpenses.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/badMiscellaneousExpenses.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/badMiscellaneousExpensesItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/badMiscellaneousExpenses<%replace%>.html',
	);
