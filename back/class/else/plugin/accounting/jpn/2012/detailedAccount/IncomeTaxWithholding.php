 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_IncomeTaxWithholding extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountIncomeTaxWithholdingWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'incomeTaxWithholding',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/incomeTaxWithholding.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/incomeTaxWithholding.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/incomeTaxWithholdingItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/incomeTaxWithholding<%replace%>.html',
	);
