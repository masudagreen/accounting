 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_Deposits extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountDepositsWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'deposits',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/deposits.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/deposits.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/depositsItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/deposits<%replace%>.html',
	);
