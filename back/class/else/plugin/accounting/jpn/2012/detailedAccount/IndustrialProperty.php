 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_IndustrialProperty extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountIndustrialPropertyWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'industrialProperty',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/industrialProperty.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/industrialProperty.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/industrialPropertyItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/industrialProperty<%replace%>.html',
	);
