 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_Employee extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountEmployeeWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'employee',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/employee.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/employee.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/employeeItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/employee<%replace%>.html',
	);
