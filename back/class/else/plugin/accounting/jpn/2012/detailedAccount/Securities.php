 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_Securities extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountSecuritiesWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'securities',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/securities.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/securities.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/securitiesItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/securities<%replace%>.html',
	);
	...
	protected function _getDetailVarsDetail($arr)
	{
		...
		$arrayStr = array('SumUpdate', 'SumMove');
		foreach ($arrayStr as $keyStr => $valueStr) {
			$tmplList = $array['varsText' . $valueStr];
