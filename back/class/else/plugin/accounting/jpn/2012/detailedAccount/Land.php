 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_Land extends Code_Else_Plugin_Accounting_Jpn_DetailedAccount
{
	protected $_extSelf = array(
		'idPreference' => 'detailedAccountLandWindow',
		'flagReport'   => '2012',
		'flagDetail'   => 'land',
		'pathTplJs'    => 'else/plugin/accounting/js/jpn/2012/detailedAccount/land.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/2012/detailedAccount/land.php',
		'pathItem'     => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/landItem.php',
		'pathTplHtml'  => 'else/plugin/accounting/html/2012/detailedAccount/land<%replace%>.html',
	);
	...
	protected function _getDetailVarsDetail($arr)
	{
		...
		$tmplList = $array['varsTextSumMargin'];
		$tmplList['idTarget'] = 'value' . $tmplList['id'];
		$varsData['str' . $tmplList['id']] = $tmplList['strTitle'];
		$dataValue = $arr['varsValue'][$tmplList['idTarget']];
		if (!is_null($dataValue)) {
