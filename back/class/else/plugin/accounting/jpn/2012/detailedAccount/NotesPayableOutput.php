 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_NotesPayableOutput extends Code_Else_Plugin_Accounting_Jpn_2012_DetailedAccount_NotesPayable
{
	protected $_childSelf = array(
		'pathVarsPrint' => 'back/tpl/vars/else/plugin/accounting/<strLang>/dat/jpn/2012/detailedAccount/notesPayablePrint.php',
	);
	...
	protected function _getVarsLoopCsv($arr)
	{
		...
		for ($i = 1; $i <= $numEnd; $i++) {
			...
			$strTextPay = $classEscape->toComma(array('data' => $varsValue['valueTextPay' . $i]));
