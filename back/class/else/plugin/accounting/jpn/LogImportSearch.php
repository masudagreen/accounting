 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_LogImportSearch extends Code_Else_Plugin_Accounting_Jpn_LogImport
{
	protected $_childSelf = array(
		'pathTplJs'  => 'else/plugin/accounting/js/jpn/logImportSearch.js',
		'pathVarsJs' => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/logImportSearch.php',
	);
	...
	protected function _iniJs()
	{
		...
		$this->_setJs(array(
			...
			'strColumnSearch'   => 'jsonLogImportNaviSearch',
			'flagEntitySearch'  => 1,
			'flagAccountSearch' => 1,
			'arrSearch'       => array(),
		));
