 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_CalcBanks_Surugabank extends Code_Else_Plugin_Accounting_Jpn_CalcBanks
{
	/**
	 *
	 */
	...
	protected function _checkValueDetailVars($arr)
	{
		...
		$strTitle = mb_substr($arr['valueLog']['strTitle'] . ' ' . $arr['valueLog']['strSection'], 0, 100);
	...
	protected function _checkValueDetailCSV($arr)
	{
		...
		$strTitle = $arr['valueLog']['strTitle'] . ' ' . $arr['valueLog']['strSection'];
