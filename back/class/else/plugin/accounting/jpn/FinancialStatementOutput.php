 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_FinancialStatementOutput extends Code_Else_Plugin_Accounting_Jpn_FinancialStatement
{
	...
	protected function _getVarsStatus($arr)
	{
		...
		*/
		...
		if ($arr['varsFlag']['flagFS'] == 'BS') {
			$varsData['strPeriodSub'] = $varsData['strPointExt'];
