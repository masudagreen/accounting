 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_BanksSearch extends Code_Else_Plugin_Accounting_Jpn_Banks
{
	protected $_childSelf = array(
		'pathTplJs'  => 'else/plugin/accounting/js/jpn/banksSearch.js',
		'pathVarsJs' => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/banksSearch.php',
	);
	...
	protected function _iniJs()
	{
		...
		$this->_setJs(array(
			...
			'strColumnSearch'   => 'jsonBanksNaviSearch',
			'flagEntitySearch'  => 1,
			'flagAccountSearch' => 1,
			'arrSearch'       => array(),
		));
