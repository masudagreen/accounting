 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_Portal_NextBreakEvenPoint extends Code_Else_Plugin_Accounting_Jpn_Portal
{
	...
	protected function _setInsertLog($arr)
	{
		...
		$varsDepartment['arrStrTitle']['0'] = 'dummy';

		$array = $rows['arrRows'];
		foreach ($array as $key => $value) {
			if (!$varsDepartment['arrStrTitle'][$value['idDepartment']]) {
				continue;
			}
