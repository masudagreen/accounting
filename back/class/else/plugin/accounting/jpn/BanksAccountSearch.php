 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_Jpn_BanksAccountSearch extends Code_Else_Plugin_Accounting_Jpn_BanksAccount
{
	protected $_childSelf = array(
		'pathTplJs'  => 'else/plugin/accounting/js/jpn/banksAccountSearch.js',
		'pathVarsJs' => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/jpn/banksAccountSearch.php',
	);
	...
	protected function _iniJs()
	{
		$this->_setJs(array(
			...
			'strColumnSearch'   => 'jsonBanksAccountNaviSearch',
			'flagEntitySearch'  => 1,
			'flagAccountSearch' => 1,
			'arrSearch'       => array(),
		));
