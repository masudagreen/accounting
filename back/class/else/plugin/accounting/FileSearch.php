 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_FileSearch extends Code_Else_Plugin_Accounting_File
{
	protected $_childSelf = array(
		'pathTplJs'    => 'else/plugin/accounting/js/fileSearch.js',
		'pathVarsJs'   => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/fileSearch.php',
	);
