 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_AuthoritySearch extends Code_Else_Plugin_Accounting_Authority
{
	protected $_childSelf = array(
		'pathTplJs' => 'else/plugin/accounting/js/authoritySearch.js',
		'pathVarsJs'  => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/authoritySearch.php',
	);
