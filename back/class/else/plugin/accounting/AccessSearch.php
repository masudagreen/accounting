 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_AccessSearch extends Code_Else_Plugin_Accounting_Access
{
	protected $_childSelf = array(
		'pathTplJs'          => 'else/plugin/accounting/js/accessSearch.js',
		'pathVarsJs'         => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/accessSearch.php',
