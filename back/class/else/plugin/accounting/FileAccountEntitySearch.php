 ...
 * http://rucaro.org/
 */
class Code_Else_Plugin_Accounting_FileAccountEntitySearch extends Code_Else_Plugin_Accounting_FileAccountEntity
{
	protected $_childSelf = array(
		'pathTplJs' => 'else/plugin/accounting/js/fileAccountEntitySearch.js',
		'pathVarsJs'  => 'back/tpl/vars/else/plugin/accounting/<strLang>/js/fileAccountEntitySearch.php',
	);
	...
	protected function _iniJs()
	{
		$this->_setJs(array(
			...
			'strColumnSearch'   => 'jsonFileAccountEntityNaviSearch',
			'flagEntitySearch'  => 1,
			'flagAccountSearch' => 1,
			'arrSearch'       => array(),
		));
