 ...
 * http://rucaro.org/
 */
class Code_Else_Core_Base_AccountSearch extends Code_Else_Core_Base_Account
{
	protected $_childSelf = array(
		'pathTplJs'  => 'else/core/base/js/accountSearch.js',
		'pathVarsJs' => 'back/tpl/vars/else/core/base/<strLang>/js/accountSearch.php',
	);
