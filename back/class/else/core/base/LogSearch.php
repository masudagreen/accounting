 ...
 * http://rucaro.org/
 */
class Code_Else_Core_Base_LogSearch extends Code_Else_Core_Base_Log
{
	protected $_childSelf = array(
		'pathTplJs'  => 'else/core/base/js/logSearch.js',
		'pathVarsJs' => 'back/tpl/vars/else/core/base/<strLang>/js/logSearch.php',
	);
