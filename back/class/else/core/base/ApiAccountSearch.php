 ...
 * http://rucaro.org/
 */
class Code_Else_Core_Base_ApiAccountSearch extends Code_Else_Core_Base_ApiAccount
{
	protected $_childSelf = array(
		'pathTplJs'  => 'else/core/base/js/apiAccountSearch.js',
		'pathVarsJs' => 'back/tpl/vars/else/core/base/<strLang>/js/apiAccountSearch.php',
	);
	...
	protected function _iniJs()
	{
		$this->_setJs(array(
			...
			'strColumnSearch' => 'jsonApiAccountNaviSearch',
			'arrSearch'       => array(),
		));
	}
