 ...
 * http://rucaro.org/
 */
class Code_Else_Core_Base_TermSearch extends Code_Else_Core_Base_Term
{
	protected $_childSelf = array(
		'pathTplJs'  => 'else/core/base/js/termSearch.js',
		'pathVarsJs' => 'back/tpl/vars/else/core/base/<strLang>/js/termSearch.php',
	);
	...
	protected function _iniJs()
	{
		$this->_setJs(array(
			...
			'strColumnSearch' => 'jsonTermNaviSearch',
			'arrSearch'       => array(),
		));
	}
