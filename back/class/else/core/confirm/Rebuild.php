 ...
 * http://rucaro.org/
 */
class Code_Else_Core_Confirm_Rebuild  extends Code_Else_Core_Base_Rebuild
{
	protected $_extSelf = array(
		'path' => array(
			'dir' => array(
				'tplCss' => 'back/tpl/templates/else/core/confirm/css/',
				'langJs' => 'back/tpl/vars/else/core/confirm/',
			),
			'file' => array(
				'outCss' => 'front/else/core/confirm/css/style.css',
				'tplJsIndex' => 'else/core/confirm/js/index.js',
				'varsJsIndex' => 'back/tpl/vars/else/core/confirm/<strLang>/js/index.php',
				'outJsIndex' => 'front/else/core/confirm/js/<strLang>/index.js',
		    ),
		),
	);
